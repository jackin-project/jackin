...
| `CAP-2` | 4 Capsule panes | in_progress | Telemetry landed for vertical scrollback flicker; blocked on a fresh `--debug` repro run id before behavior change | telemetry + `cargo nextest run -p jackin-capsule` |
