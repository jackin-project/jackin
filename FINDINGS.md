...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 86 Rust files and 34,829 lines, versus 143 Rust files and 47,022 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 86 | 34,829 | Remaining root console implementation |
...
| `tui/` | 71 | 32,083 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
