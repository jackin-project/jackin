...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 80 Rust files and 34,655 lines, versus 143 Rust files and 49,764 lines in `crates/jackin-console/src`.
