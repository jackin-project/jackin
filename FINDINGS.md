...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 86 Rust files and 34,680 lines, versus 143 Rust files and 48,016 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 86 | 34,680 | Remaining root console implementation |
...
| `tui/` | 71 | 31,934 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
