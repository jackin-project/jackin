...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 80 Rust files and 34,637 lines, versus 143 Rust files and 48,191 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 80 | 34,637 | Remaining root console implementation |
...
| `tui/` | 65 | 31,891 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
