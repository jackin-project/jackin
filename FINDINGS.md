...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 80 Rust files and 35,199 lines, versus 143 Rust files and 44,402 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 80 | 35,199 | Remaining root console implementation |
...
| `tui/` | 65 | 32,453 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
