...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 81 Rust files and 35,249 lines, versus 143 Rust files and 42,607 lines in `crates/jackin-console/src`.
...
| `tui/` | 66 | 32,546 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
