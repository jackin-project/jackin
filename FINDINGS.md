...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 81 Rust files and 35,374 lines, versus 143 Rust files and 37,968 lines in `crates/jackin-console/src`.
...
| `tui/` | 66 | 32,670 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
