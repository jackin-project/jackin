...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 80 | 34,423 | Remaining root console implementation |
...
| `tui/` | 65 | 31,677 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
