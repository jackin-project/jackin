...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 86 Rust files and 34,840 lines, versus 143 Rust files and 46,857 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 86 | 34,840 | Remaining root console implementation |
...
| `tui/` | 71 | 32,094 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
