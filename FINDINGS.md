...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 81 Rust files and 35,368 lines, versus 143 Rust files and 40,016 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 81 | 35,368 | Remaining root console implementation |
...
| `tui/` | 66 | 32,690 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
