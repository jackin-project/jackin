...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 80 Rust files and 34,567 lines, versus 143 Rust files and 48,677 lines in `crates/jackin-console/src`.
...
| `tui/` | 65 | 31,821 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
