...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 80 Rust files and 34,568 lines, versus 143 Rust files and 48,850 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 80 | 34,568 | Remaining root console implementation |
...
| `tui/` | 65 | 31,822 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
