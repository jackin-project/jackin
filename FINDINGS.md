...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 86 Rust files and 34,825 lines, versus 143 Rust files and 47,152 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 86 | 34,825 | Remaining root console implementation |
...
| `tui/` | 71 | 32,079 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
