...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 86 Rust files and 34,859 lines, versus 143 Rust files and 46,786 lines in `crates/jackin-console/src`.
...
| `tui/` | 71 | 32,113 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
