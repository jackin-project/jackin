...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 81 Rust files and 35,330 lines, versus 143 Rust files and 43,847 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 81 | 35,330 | Remaining root console implementation |
...
| `tui/` | 66 | 32,592 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
