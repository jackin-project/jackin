...
`crates/jackin/src/console` is not a small entrypoint shim today. It is the largest remaining part of the host console implementation: 81 Rust files and 35,354 lines, versus 143 Rust files and 43,719 lines in `crates/jackin-console/src`.
...
|---|---:|---:|---|
| `crates/jackin/src/console` total | 81 | 35,354 | Remaining root console implementation |
...
| `tui/` | 66 | 32,616 | Remaining TUI state, input, update, rendering adapters, run loop, tests |
