...
pub fn prepare_for_render(
    ...
    match &mut state.stage {
        ManagerStage::Editor(editor) => {
            let footer = crate::console::tui::components::editor_footer::editor_footer_items(
                editor,
                config,
                state.op_available,
            );
        ...
        ManagerStage::Settings(settings) => {
            let footer = crate::console::tui::components::settings_footer::settings_footer_items(
                settings,
                state.op_available,
            );
