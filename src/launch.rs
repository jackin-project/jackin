...
fn draw_workspace_screen(frame: &mut ratatui::Frame, state: &LaunchState) {
    ...
    let footer = Paragraph::new(Line::from(vec![
        Span::styled("  Enter ", Style::default().fg(colors::MATRIX_GREEN).add_modifier(Modifier::BOLD)),
        Span::styled("select   ", Style::default().fg(colors::DIM_GREEN)),
        Span::styled("↑↓ ", Style::default().fg(colors::MATRIX_GREEN).add_modifier(Modifier::BOLD)),
        Span::styled("navigate   ", Style::default().fg(colors::DIM_GREEN)),
        Span::styled("Esc ", Style::default().fg(colors::MATRIX_GREEN).add_modifier(Modifier::BOLD)),
...
fn draw_agent_screen(frame: &mut ratatui::Frame, state: &LaunchState) {
    ...
    let footer = Paragraph::new(Line::from(vec![
        ...
        Span::styled("↑↓ ", Style::default().fg(colors::MATRIX_GREEN).add_modifier(Modifier::BOLD)),
        Span::styled("navigate   ", Style::default().fg(colors::DIM_GREEN)),
        Span::styled("Type ", Style::default().fg(colors::MATRIX_GREEN).add_modifier(Modifier::BOLD)),
