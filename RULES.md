...
Symlink = one source of truth on disk: two paths resolve to same bytes, so tool file never drift from `AGENTS.md`. Instructions shared across all AI agents regardless of tool.
