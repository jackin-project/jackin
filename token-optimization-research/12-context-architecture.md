...
- **Layer:** input — never-load (instructions)
- **Mechanism:** `.claude/rules/*.md` with `paths` frontmatter "only load when Claude works with matching files" (features-overview). Same pattern as this repo's per-directory AGENTS.md auto-loading.
