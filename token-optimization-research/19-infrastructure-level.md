...
| 6 | vLLM V1: "less than 1% decrease in throughput even when the cache hit rate is 0%"; default-on; "several times" at high hit rate | https://vllm.ai/blog/-v1-alpha-release (refetched; source typo "perfix" sic) | |
...
| 9 | "Up to 5x" + baselines vllm v0.2.5 / guidance v0.1.8 / TGI v1.3.0 | https://www.lmsys.org/blog/-sglang/ (sweep-fetched) | |
| 10 | HiCache internal "up to 6x throughput / up to 80% TTFT cut"; Novita Qwen3-Coder-480B 25K-tok ~8-turn: TTFT −56%, throughput 2x, hit 40%→80%; Ant DeepSeek-R1-671B: −84% TTFT; tiers + `--hicache-ratio 2` | https://www.lmsys.org/blog/-sglang-hicache/ (refetched) | |
| 11 | Router "up to 1.9x throughput / 3.8x hit rate"; 82,665→158,596 tok/s; 20%→75%; approximate radix tree, communication-free; workload caveat | https://www.lmsys.org/blog/-sglang-v0-4/ (refetched) | |
