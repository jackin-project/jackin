...
pub static WORDLIST: &[&str] = &[
    // Animals
    "badger", "crane", "falcon", "gecko", "heron", "ibex", "jackal", "kite", "lynx", "mink",
    "newt", "otter", "puma", "quail", "raven", "stoat", "teal", "vole", "wren", "yak",
    "adder", "bison", "cobra", "dingo", "egret", "finch", "grebe", "hyena", "impala", "jaguar",
    "kudu", "lemur", "moose", "narwhal", "ocelot", "puffin", "quokka", "robin", "skunk",
    "tapir", "urubu", "viper", "wombat", "xerus", "zebu", "axolotl", "boar", "coyote",
    "dhole", "ermine", "ferret", "goshawk", "harrier", "iguazu", "junco", "kestrel",
    "limpet", "marten", "nutria", "osprey", "petrel",
    // Landforms
    "arch", "bay", "bluff", "cape", "cliff", "crag", "delta", "dune", "fjord", "gorge",
    "gulch", "inlet", "isle", "knoll", "ledge", "mesa", "moor", "peak", "reef", "ridge",
    "scarp", "shelf", "shoal", "sill", "spit", "spur", "steppe", "swale", "talus", "tor",
    "vale", "atoll", "butte", "cirque", "draw", "flats", "gully", "heath", "karst",
    "loch", "marsh", "notch", "overhang", "plain", "quarry", "ravine", "scree", "tarn",
    "vent", "wash", "xenolith", "yardang",
    // Weather and celestial
    "aurora", "cirrus", "frost", "gale", "haze", "mist", "nimbus", "squall", "storm",
    "surge", "tide", "veil", "zephyr", "anvil", "bora", "cloud", "drizzle", "eddy",
    "flurry", "gloom", "hail", "inflow", "jetstream", "katabatic", "lull",
    "mirage", "nebula", "overcast", "plume", "quasar", "rime", "sleet",
];
...
mod tests {
    ...
    fn pick_codename_fallback_when_pool_exhausted() {
        ...
        let name = pick_codename(&live, &retired, 0);
        assert!(name.contains('-'), "fallback name should contain '-': {name}");
    }
}
