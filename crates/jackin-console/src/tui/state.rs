...
#[derive(Debug)]
#[allow(clippy::struct_excessive_bools, reason = "documented residual allow; prefer expect when site is lint-true")] // independent UI focus flags, not a config-style bag
pub struct ManagerState<'a> {
    ...
    #[allow(clippy::type_complexity, reason = "documented residual allow; prefer expect when site is lint-true")]
