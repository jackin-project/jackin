...
) -> crate::tui::components::ErrorPopupState {
    crate::tui::components::ErrorPopupState::new(title, message)
}
...
pub fn no_github_url_error_popup_state() -> crate::tui::components::ErrorPopupState {
    error_popup_state(
        "No GitHub URL",
