...
generated_instruments! {
    ...
    UI_JANK => UI_JANK_DEF,
    LAUNCH_STAGE_EXECUTIONS => LAUNCH_STAGE_EXECUTIONS_DEF,
    LAUNCH_STAGE_ACTIVE => LAUNCH_STAGE_ACTIVE_DEF,
    LAUNCH_STAGE_DURATION => LAUNCH_STAGE_DURATION_DEF,
    CACHE_DECISIONS => CACHE_DECISIONS_DEF,
    ...
    GEN_AI_CLIENT_TOKEN_USAGE => GEN_AI_CLIENT_TOKEN_USAGE_DEF,
