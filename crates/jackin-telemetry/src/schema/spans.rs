...
// registry: kind=internal; attributes=app.screen.id:required,cli.invocation.id:recommended,outcome:recommended,session.id:recommended,ui.screen.previous.id:required,ui.transition.reason:required
