    ...
    S: Future<Output = anyhow::Result<()>>,
{
    ...
    let staged_account_credentials =
        crate::usage_relay::staged_selected_account_credentials(config, &instances, &credentials);
    ...
    if backend == super::super::super::Backend::AppleContainer {
        ...
        crate::runtime::apple_container::launch(
            crate::runtime::apple_container::AppleContainerLaunch {
                ...
                state: &state,
                resolved_env,
                staged_account_credentials: &staged_account_credentials,
                debug: opts.debug,
            },
        )
        .await?;
