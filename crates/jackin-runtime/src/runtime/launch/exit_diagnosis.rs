...
#[allow(clippy::unnecessary_wraps, reason = "documented residual allow; prefer expect when site is lint-true")] // Result preserved so callers' `?` keeps working without a churn-y signature change
