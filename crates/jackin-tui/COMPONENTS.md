...
| `ButtonStrip` | `jackin_tui::components::button_strip` | Confirm dialog, confirm-save modal, scope picker | 3 — shared Ratatui primitive | New button rows should consume this instead of declaring focused/unfocused button styles locally. |
