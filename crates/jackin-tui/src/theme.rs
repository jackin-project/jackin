...
use crate::{
    ...
    PHOSPHOR_DARK as PHOSPHOR_DARK_RGB,
    PHOSPHOR_DIM as PHOSPHOR_DIM_RGB, PHOSPHOR_GREEN as PHOSPHOR_GREEN_RGB,
    PREVIEW_CARD as PREVIEW_CARD_RGB, Rgb, TAB_BG_ACTIVE as TAB_BG_ACTIVE_RGB,
...
pub const CAPSULE_PANE_FOCUSED: Color = color(CAPSULE_PANE_FOCUSED_RGB);
