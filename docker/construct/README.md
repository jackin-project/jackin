...
| `starship.toml` | Shared prompt config for zsh and fish; renders the `j❯` sigil with the canonical green chevron and prefixes the active `JACKIN_AGENT` when present. |
