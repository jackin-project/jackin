...
1. **Styled CLI help** — Matrix-themed clap colors, rain/jack banner in `--help`, Matrix-flavored command descriptions
...
Matrix green palette via `Styles::styled()`:
...
- Add `HELP_STYLES` constant with Matrix green color palette
