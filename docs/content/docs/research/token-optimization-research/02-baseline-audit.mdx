...
| <RepoFile path="BRANCHING.md">BRANCHING.md</RepoFile> | 1,147 | 3,434 | 2.99 |
| <RepoFile path="COMMITS.md">COMMITS.md</RepoFile> | 1,460 | 4,217 | 2.89 |
...
<RepoFile path="PULL_REQUESTS.md">PULL_REQUESTS.md</RepoFile> (10,933) + <RepoFile path="COMMITS.md">COMMITS.md</RepoFile> + <RepoFile path="BRANCHING.md">BRANCHING.md</RepoFile> ≈ 13.5k tokens of instructions. Memory
