...
<RepoFile path="docs/content/docs/reference/roadmap/architect-code-intelligence-tooling.mdx">docs/content/docs/reference/roadmap/architect-code-intelligence-tooling.mdx</RepoFile>.
...
[`52-qdrant-and-vector-databases.md`](/research/token-optimization/52-qdrant-and-vector-databases/).
...
- ast-grep CLI/skill decision record for jackin❯ roles: <RepoFile path="docs/content/docs/reference/roadmap/architect-code-intelligence-tooling.mdx">docs/content/docs/reference/roadmap/architect-code-intelligence-tooling.mdx</RepoFile>
