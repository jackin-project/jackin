...
This folder is a re-synthesis of the dossier's primary research; the full per-claim ledgers (with URLs and access dates) live in the chapters below. Key sources:
