...
Behavioral invariant contract for the 1Password picker state machine spread across <RepoFile path="crates/jackin/src/console/tui/op_picker.rs">crates/jackin/src/console/tui/op_picker.rs</RepoFile> (root-console adapter) and <RepoFile path="crates/jackin-console/src/tui/components/op_picker.rs">crates/jackin-console/src/tui/components/op_picker.rs</RepoFile> (surface-local render/state helpers).
