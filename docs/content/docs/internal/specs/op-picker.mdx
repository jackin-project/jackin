...
Behavioral invariant contract for the 1Password picker state machine spread across `src/console/tui/op_picker/` (root-console adapter) and <RepoFile path="crates/jackin-console/src/tui/components/op_picker.rs" /> (surface-local render/state helpers).
