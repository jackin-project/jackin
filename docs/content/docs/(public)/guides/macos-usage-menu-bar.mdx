...
- Template jackin❯ logomark plus an optional short monospaced percent for the busiest enabled account (for example `Cl 63%`). Toggle **Show percent in menu bar** in Settings (default on).
