...
For the schema, identity, propagation, current delivery contract, and typed host and Capsule daemon health, see [Application observability](/reference/runtime/diagnostics/).
