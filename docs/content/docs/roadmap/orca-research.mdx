...
Every borrowed idea must survive the values filter from the [Agent Orchestrator Research program](/roadmap/agent-orchestrator-research/#jackin-values-used-for-evaluation).
...
| Mobile companion (monitor, manage) | Yes | Lower priority; relevant to [jackin❯ Desktop Agent Hub](/roadmap/jackin-desktop-agent-hub/) |
...
| Mobile companion | iOS + Android | Not yet; see [jackin❯ Desktop Agent Hub](/roadmap/jackin-desktop-agent-hub/) |
...
The iOS/Android companion for remote monitoring and task management is an idea for the [jackin❯ Desktop Agent Hub](/roadmap/jackin-desktop-agent-hub/) roadmap item, which uses the daemon as its state/event backend.
...
| Mobile companion | [jackin❯ Desktop Agent Hub](/roadmap/jackin-desktop-agent-hub/) |
