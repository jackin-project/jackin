...
- **[Agent Orchestration Program](/roadmap/agent-orchestrator-research/)** — Herdr is evaluated there as the strongest prior art for the multiplexer vision. The full comparative table (Herdr vs. jackin❯ values) lives in the research overview.
