...
Everything else — per-container event subscription, click-to-focus, and the console Notifications tab — is unbuilt. The completed scoped implementation plan is <RepoFile path="plans/048-attention-adapter-foundation.md" />.
