...
- <RepoFile path="crates/jackin-runtime/src/isolation/finalize.rs" /> — host `assess_cleanup` wrapper and `ExitActionPrompt` keep/discard execution.
