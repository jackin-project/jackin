...
**Status**: Open — design proposal (Phase 1, [Agent Orchestrator Research Program](/roadmap/agent-orchestrator-research/))
...
- **Apple container** (when [selectable
  backends](/roadmap/selectable-sandbox-backends/) ships):
