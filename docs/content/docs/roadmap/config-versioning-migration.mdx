...
On every startup, `AppConfig::load_or_init` (in <RepoFile path="crates/jackin-config/src/app_config/persist.rs">crates/jackin-config/src/app_config/persist.rs</RepoFile>) runs the migration step before deserializing into typed structs:
...
1. Add `version` extraction to the raw TOML read layer in <RepoFile path="crates/jackin-config/src/app_config/persist.rs">crates/jackin-config/src/app_config/persist.rs</RepoFile> (before deserialization into `AppConfig`).
...
- <RepoFile path="crates/jackin-config/src/app_config/persist.rs">crates/jackin-config/src/app_config/persist.rs</RepoFile> — `AppConfig::load_or_init`, the migration entry point.
...
- <RepoFile path="crates/jackin-config/src/app_config.rs">crates/jackin-config/src/app_config.rs</RepoFile> — `AppConfig` and workspace config structs.
