...
- [Split input/editor.rs](/roadmap/split-input-editor/) and [Split app/mod](/roadmap/split-app-mod/) — sibling codebase-health items on the same input/modal layer; sequence the unification with these so the splits divide one implementation.
