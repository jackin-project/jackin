...
- This is the smallest feature in the [Agent Orchestrator Research
...
- <RepoFile path="crates/jackin-config/src/app_config/workspaces.rs">crates/jackin-config/src/app_config/workspaces.rs</RepoFile> — `workspace show` renderer
