...
**Status**: Deferred — shared-kernel architecture does not address the kernel isolation gap for the current macOS ARM audience; see [smolvm backend research](/roadmap/smolvm-backend-research/) for the active VM isolation track
