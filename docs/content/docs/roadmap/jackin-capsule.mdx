...
- See [jackin❯ daemon](/roadmap/jackin-daemon/) and [jackin❯ Desktop Agent Hub](/roadmap/jackin-desktop-agent-hub/).

## Relationship to other roadmap items

- **[Agent Orchestrator Research Program](/roadmap/agent-orchestrator-research/)** — Herdr is evaluated there as the strongest prior art for the multiplexer vision. The full comparative table (Herdr vs. jackin❯ values) lives in the research overview.
...
- **[jackin❯ Desktop Agent Hub](/roadmap/jackin-desktop-agent-hub/)** — Phase 3 of this item is the prerequisite: the desktop app's live session view is driven by `jackin-capsule` socket events aggregated by the daemon.
