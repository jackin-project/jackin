...
| [Credential source pattern](/roadmap/credential-source-pattern/) | 5 | Open — design complete |
| [Container credential exposure](/reference/research/security/credential-exposure/container-credential-exposure/) | 6 | Open — design complete |
