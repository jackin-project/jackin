...
│ MiniMax     unsupported                        │
├────────────────────────────────────────────────┤
│ Open Usage…                  Settings… · Quit  │
└────────────────────────────────────────────────┘
```

Rows = `FocusedUsageView.tabs` one-liners with the shared provider display labels; clicking a row opens the Usage window focused on that provider.
