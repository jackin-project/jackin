...
- **Out of scope forever:** token unit prices and historical usage/spend trends (donuts, sparklines, 30-day cost series) — limits-only product rule in root / crate / native `AGENTS.md`.
