...
**Status**: Partially implemented — implementation plans complete (PR #794). Execution of the six stages (freeze, external history, workspace foundations, widget neutralization, adapters and first publish, revision consumable quality, migration, donor retirement, stabilize and tag) remains to be done.
