...
- [Claude auth strategy](/reference/research/authentication/claude-auth-strategy/)
...
- **Forwarding interaction with [Claude auth
  strategy](/reference/research/authentication/claude-auth-strategy/).** That item is
