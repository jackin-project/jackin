...
- **Sampling backend abstraction.** Sample-via-Docker today; sample-via-
  ...
  backends](/reference/research/security/sandbox-backends/selectable-sandbox-backends/) lands. Which
...
- **Always-on vs on-demand sampling.** multicode samples constantly even
  ...
  call. Revisit when [Token & Cost Telemetry](/reference/research/agent-telemetry/token-cost-telemetry/) needs continuous series.
