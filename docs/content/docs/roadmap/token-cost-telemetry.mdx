...
**Status**: Partially implemented (Phase 3, [Agent Orchestrator Research Program](/roadmap/agent-orchestrator-research/))
...
samples land in the
[persistent storage layer](/roadmap/persistent-storage-layer/)'s
`usage_samples` table.
...
- [jackin❯ Desktop Agent Hub](/roadmap/jackin-desktop-agent-hub/) — desktop account/quota rendering home
