...
The detailed executor plans that include sensitive examples live under <RepoFile path="security-review/README.md">security-review/README.md</RepoFile>. Keep those out of routine <RepoFile path="plans/">plans/</RepoFile> work so a code-health executor can work without loading them.
