...
**Status**: Open — split out from the completed routine codebase-health track so credential, secret, supply-chain, and control-surface work remains independently reviewable.
