...
The detailed executor plans that include sensitive examples live under <RepoFile path="security-review/README.md">security-review/README.md</RepoFile>. Keep those out of <RepoFile path="plans/code-health/README.md">plans/code-health/README.md</RepoFile> so a routine code-health executor can work without loading them.
