...
2. [OrbStack isolated machine backend](/reference/research/isolation/orbstack-isolated-machines/)
   - research a macOS backend that runs the role container and private Docker engine inside an OrbStack isolated machine.
3. [smolvm backend research](/reference/research/isolation/smolvm-backend/) - evaluate an open Rust/libkrun VM backend for true VM-per-workload isolation, OCI-image execution, and potential SDK integration; compare it directly with OrbStack isolated machines and Docker Sandboxes.
...
| [OrbStack isolated machine backend](/reference/research/isolation/orbstack-isolated-machines/) | macOS isolated-machine lifecycle, selective shares, machine-local Docker, image transfer, attach/reconnect/eject/purge. |
| [smolvm backend research](/reference/research/isolation/smolvm-backend/) | Open Rust/libkrun VM backend research: direct OCI execution, persistent machines, Docker workflow compatibility, network allow-host policy, and SDK embedding. |
