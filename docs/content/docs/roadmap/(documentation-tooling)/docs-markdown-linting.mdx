...
- <RepoFile path="docs/scripts/check-repo-links.ts">docs/scripts/check-repo-links.ts</RepoFile> — existing custom-rule precedent rumdl complements, not replaces.
