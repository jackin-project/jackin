...
Works on top of any jackin' backend. Does not require the Apple Container backend to land first. See [Agent isolation architecture](/roadmap/agent-isolation-architecture/) for the complete picture.
...
| Item | Relationship |
|---|---|
| [Agent isolation architecture](/roadmap/agent-isolation-architecture/) | Master architecture doc; jackin-exec is Layer 3 |
| [Container credential exposure](/roadmap/container-credential-exposure/) | The problem this item solves |
...
| [Process-level sandboxing](/roadmap/process-level-sandboxing/) | Complementary — zerobox handles per-operation filesystem/network policy |
