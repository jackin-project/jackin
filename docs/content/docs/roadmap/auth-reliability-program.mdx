...
*Addressed in Phase 6 (parallel track). See [Container credential exposure](/roadmap/container-credential-exposure/).*
...
**Detail:** [Container credential exposure](/roadmap/container-credential-exposure/).
...
| [Container credential exposure](/roadmap/container-credential-exposure/) | 6 | Open — design complete |
| [Host bridge — secrets and approved host actions](/roadmap/host-bridge/) | 7 | Open — design complete, awaits daemon |
| [Reliable Claude authentication strategy](/roadmap/claude-auth-strategy/) | Historical context for current mode design | Deferred |
