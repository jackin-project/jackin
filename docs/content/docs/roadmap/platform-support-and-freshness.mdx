...
- [/roadmap/smolvm-backend-research/](/roadmap/smolvm-backend-research/) — Linux/KVM support affects platform matrix
- [/roadmap/orbstack-isolated-machine-backend/](/roadmap/orbstack-isolated-machine-backend/) — macOS-only backend
- [/roadmap/selectable-sandbox-backends/](/roadmap/selectable-sandbox-backends/) — backend selection affects platform support
