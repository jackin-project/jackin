...
description: Forward Claude Code, Codex, Amp, Kimi, and OpenCode credentials into agent containers
---
...
The secondary agent's credentials were already placed in the container when Claude Code, Codex, Amp, Kimi, or OpenCode launched the first session. For the full workflow, see [Parallel Agents](/guides/parallel-agents/).
...
- shows which scope chose which mode for `Claude`, `Codex`, `Amp`, `Kimi`, and `OpenCode`, and
