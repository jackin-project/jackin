...
[
  ...
  {"codename": "falcon", "agent": "claude", "provider": "anthropic", "started_at": "2026-06-04T10:32:15Z", "exited_at": null, "status": "active", "self": false},
...
The Capsule tab strip shows the agent type and provider for each tab. The codename for a tab is visible in the **hover tooltip** — move your mouse cursor over a tab cell to see its codename, agent, provider, start time, and exit time.
