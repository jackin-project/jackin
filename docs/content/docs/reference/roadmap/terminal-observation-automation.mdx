...
- [TUI Design Decisions](/reference/tui-design-decisions/) and [snapshot tests for TUI](/reference/roadmap/snapshot-tests-tui/) — renderer/golden-test work that should converge with the terminal-frame artifact model.
