...
- Keep local file references linked with `<RepoFile />` when this roadmap item is updated; the key implementation seams are <RepoFile path="crates/jackin-protocol/src/control/mod.rs" />, <RepoFile path="crates/jackin-capsule/src/socket/mod.rs" />, <RepoFile path="crates/jackin-capsule/src/session/mod.rs" />, <RepoFile path="crates/jackin-capsule/src/daemon/mod.rs" />, and <RepoFile path="src/runtime/snapshot/mod.rs" />.
