...
- [TUI Design Decisions](/reference/tui//) and [visual snapshot testing (CLI & TUI)](/reference/roadmap/visual-snapshot-testing/) — deterministic renderer/golden-test work that should converge with this terminal-frame artifact model on a shared styled-cell schema; that item asserts render regressions, this one captures live sessions for orchestration.
