...
- **Greps for basename** (e.g., `op_picker` for <RepoFile path="src/console/tui/widgets/op_picker/mod.rs" />) — PROJECT_STRUCTURE.md uses prose descriptions containing the module name.
