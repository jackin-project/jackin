...
- **Greps for basename** (e.g., `op_picker` for <RepoFile path="crates/jackin/src/console/tui/op_picker.rs">crates/jackin/src/console/tui/op_picker.rs</RepoFile>) — PROJECT_STRUCTURE.md uses prose descriptions containing the module name.
