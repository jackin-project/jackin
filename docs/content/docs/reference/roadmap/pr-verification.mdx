...
- **Phase 3 — In-surface verbs + relevance (the diff-driven spine).** Build / run-named / refresh from review mode; map the PR's changed files to the relevant commands and list them first; suggestion-not-skip; de-selection logging.
