...
- Z.AI (GLM Coding Plan) as an alternative provider for Claude Code sessions — `ZAI_API_KEY` env injection, in-container and console provider picker, and `AuthKind::Zai` auth tab row; see [Z.AI authentication](/guides/authentication/zai/)
