...
**Status**: Partially implemented — image recipe labels and warm local-image reuse shipped; attach-first restore, credential laziness, selected-runtime foreground prep, build-path surgery, and prewarm remain open
