...
Remaining Phase 3 work is daemon-backed prewarm beyond the CLI, explicit image prewarm, and saved-workspace console action. The broader item still needs deeper build-path surgery, daemon-maintained prewarm surfaces, and persistent warmed runtime resources.
