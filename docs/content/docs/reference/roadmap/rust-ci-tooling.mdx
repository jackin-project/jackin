...
6. Add `insta` as a workspace dev-dependency; write the first snapshots for launch-progress renders, dialog redraws, and capsule chrome, coordinating with the [TUI architecture](/reference/roadmap/tui-architecture/) refactor.
