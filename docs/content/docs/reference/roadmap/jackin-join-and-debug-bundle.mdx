...
- <RepoFile path="src/diagnostics/mod.rs" /> — existing diagnostics framework
- <RepoFile path="src/operator_env/mod.rs" /> — env resolution (redaction source)
- <RepoFile path="src/instance/auth/mod.rs" /> — credential locations (redaction targets)
