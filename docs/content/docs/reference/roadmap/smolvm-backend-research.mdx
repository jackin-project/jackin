...
- <RepoFile path="src/runtime/image/mod.rs" /> - role image build path and OCI artifact source.
- <RepoFile path="src/instance/manifest/mod.rs" /> - future backend/provider handles.
