...
The preflight/promotion trail must produce these artifacts. Phase 0 evidence is enough for opt-in implementation; default-on promotion still requires the live-validation artifacts named below.
