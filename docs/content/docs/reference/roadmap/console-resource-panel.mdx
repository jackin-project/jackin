...
- **Always-on vs on-demand sampling.** multicode samples constantly even
  ...
  call. Revisit when [Token & Cost Telemetry](/reference/roadmap/token-cost-telemetry/) needs continuous series.
...
- <RepoFile path="crates/jackin/src/console/tui/state.rs">crates/jackin/src/console/tui/state.rs</RepoFile> — keybinding wiring
