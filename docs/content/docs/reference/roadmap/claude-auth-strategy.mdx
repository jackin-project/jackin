...
- <RepoFile path="src/config/roles.rs" /> — auth mode resolution (`resolve_auth_forward_mode`, `set_agent_auth_forward`)
...
- [Configuration](/reference/configuration/) — config format updates
...
- <RepoFile path="src/config/mod.rs" /> — `AuthForwardMode` enum, persistence types
- <RepoFile path="src/config/roles.rs" /> — auth mode resolution
...
- [Configuration](/reference/configuration/) — persisted config schema
