...
- <RepoFile path="crates/jackin-config/src/app_config_roles.rs" /> — auth mode resolution (`resolve_auth_forward_mode`, `set_agent_auth_forward`)
- <RepoFile path="crates/jackin/src/config.rs" /> — `AuthForwardMode` enum, persistence types
- <RepoFile path="crates/jackin/src/cli/config.rs" /> — `config auth` subcommand help text and examples
- <RepoFile path="crates/jackin/src/app.rs" /> — `config auth` command dispatch
- <RepoFile path="crates/jackin-runtime/src/instance/auth.rs" /> — auth provisioning semantics for the new mode
- <RepoFile path="crates/jackin-runtime/src/runtime/launch.rs" /> — runtime env injection and launch-time warnings
...
- <RepoFile path="crates/jackin/src/config.rs" /> — `AuthForwardMode` enum, persistence types
- <RepoFile path="crates/jackin-config/src/app_config_roles.rs" /> — auth mode resolution
- <RepoFile path="crates/jackin/src/cli/config.rs" /> — `jackin config auth` help text
- <RepoFile path="crates/jackin/src/app.rs" /> — auth config command handlers
- <RepoFile path="crates/jackin-runtime/src/instance/auth.rs" /> — credential forwarding and state preparation
- <RepoFile path="crates/jackin-runtime/src/runtime/launch.rs" /> — launch-time env injection and notices
