...
- <RepoFile path="src/config/roles/mod.rs" /> — auth mode resolution (`resolve_auth_forward_mode`, `set_agent_auth_forward`)
- <RepoFile path="src/config/mod.rs" /> — `AuthForwardMode` enum, persistence types
- <RepoFile path="src/cli/config/mod.rs" /> — `config auth` subcommand help text and examples
- <RepoFile path="src/app/mod.rs" /> — `config auth` command dispatch
- <RepoFile path="src/instance/auth/mod.rs" /> — auth provisioning semantics for the new mode
- <RepoFile path="src/runtime/launch/mod.rs" /> — runtime env injection and launch-time warnings
...
- <RepoFile path="src/config/mod.rs" /> — `AuthForwardMode` enum, persistence types
- <RepoFile path="src/config/roles/mod.rs" /> — auth mode resolution
- <RepoFile path="src/cli/config/mod.rs" /> — `jackin config auth` help text
- <RepoFile path="src/app/mod.rs" /> — auth config command handlers
- <RepoFile path="src/instance/auth/mod.rs" /> — credential forwarding and state preparation
- <RepoFile path="src/runtime/launch/mod.rs" /> — launch-time env injection and notices
