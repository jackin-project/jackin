...
- [split workspace-file layout](/reference/configuration/#one-file-per-workspace-by-design) — sibling ergonomics item; migration must handle both the monolithic and split layouts if both can exist in the field.
