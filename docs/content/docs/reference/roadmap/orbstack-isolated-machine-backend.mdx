...
2. **V2: workspace registry cache integration** for layer reuse once [Workspace registry cache](/reference/roadmap/workspace-registry-cache/) lands. Image transfer cost should drop to changed layers only.
