...
- [Runtime restore and image architecture](/reference/roadmap/instant-launch-architecture/) — the shipped lifecycle mechanism that restores agent conversation history onto the host; Déjà Vu's primary capture source.
