...
- <RepoFile path="crates/jackin-manifest/src/manifest.rs" /> — `[runtime.idle]` schema
- <RepoFile path="crates/jackin-runtime/src/runtime/launch.rs" /> — wires supervisor into
  instance lifecycle
- The persistent-storage module — cleanup history table
- <RepoFile path="crates/jackin/src/console/tui/state.rs" /> — last-cleanup
  display
