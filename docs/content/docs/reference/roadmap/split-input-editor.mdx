...
Its render counterpart <RepoFile path="src/console/tui/view/editor.rs" /> is now **3331L** (was ~1682L — nearly doubled). Both files should be split together as a paired operation.
