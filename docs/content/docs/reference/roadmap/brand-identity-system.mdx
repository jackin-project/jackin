...
- Net-new terminal art only: the frozen-rain `--help` banner field and a full version/splash redesign. The CLI/Capsule brand *text* (`jackin❯`) and the green-block pill (black word, white chevron) on every jackin-owned surface already shipped; what remains deferred is the larger rain/banner artwork, not the mark itself.
