...
- <RepoFile path="crates/jackin/src/tui/output.rs" /> — CLI output helpers and terminal title
- <RepoFile path="crates/jackin-tui/src/lib.rs" /> — current TUI logo animation
