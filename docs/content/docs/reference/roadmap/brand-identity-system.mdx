...
Website and docs work should replace the old apostrophe wordmark with the proposed wordmark and tokenized brand colors in one coordinated PR. The current docs title override in <RepoFile path="docs/src/components/chrome/SiteTitle.tsx" /> and theme tokens in <RepoFile path="docs/src/styles/docs-theme.css" /> are likely first-touch files.
...
- <RepoFile path="docs/src/routes/index.tsx" /> — landing page
- <RepoFile path="docs/src/components/chrome/SiteTitle.tsx" /> — docs header wordmark
