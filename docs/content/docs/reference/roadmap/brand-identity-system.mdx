...
The brand identity system is sequenced after the [Launch Progress TUI](/reference/roadmap/launch-progress-tui/) work. Launch progress owns the operator's live launch experience: compact stage layout, identity panel, diagnostics handle, failure dialog rules, reduced-motion behavior, and the boundary-rain lifecycle. Branding should supply the mark, color tokens, wordmark/byline rules, prompt sigil, static help/README/OG treatments, and reusable visual assets on top of that foundation.
...
| App icon | Dark or light monogram variant finalized in the icon sketch pass, 1024x1024 source, rounded corners at roughly 22% of edge length |
...
- [Launch Progress TUI](/reference/roadmap/launch-progress-tui/) — product-surface foundation for launch visualization, rain lifecycle, stage vocabulary, and diagnostics boundaries.
