...
- <RepoFile path="crates/jackin-runtime/src/runtime/launch.rs" /> — launch orchestration; policy derivation hook
- <RepoFile path="crates/jackin-config/src/mounts.rs" /> — mount resolution; source of per-mount access intent
