...
- <RepoFile path="src/runtime/launch/mod.rs" /> — launch orchestration; policy derivation hook
- <RepoFile path="src/workspace/mounts/mod.rs" /> — mount resolution; source of per-mount access intent
