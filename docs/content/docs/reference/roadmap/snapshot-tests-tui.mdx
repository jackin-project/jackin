...
- <RepoFile path="src/console/tui/render/settings.rs" /> is now **839L** (new sub-module)
...
| Function | File | What to snapshot |
|---|---|---|
| Global mounts editor rendering | <RepoFile path="src/console/tui/render/settings.rs" /> | Per-subtab renders. New 839L file with no snapshot coverage. |
