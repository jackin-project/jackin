...
| [Session keep and resume](/reference/roadmap/session-keep-and-resume/) | Hazmat restore/persistence and Docker Sandboxes sandbox persistence, applied to jackin' exit/relaunch | Unique container identity and restore; console agent session control |
