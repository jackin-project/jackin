...
| Proof/governance boundary | Model launch/finalization ordering where host-side effects become complex | [Architecture decision records](/reference/roadmap/architecture-decision-records/), [behavioral runtime/launch spec](/reference/roadmap/behavioral-spec-runtime-launch/) |
