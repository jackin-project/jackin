...
- <RepoFile path="crates/jackin-manifest/src/manifest.rs" /> — `[runtime.limits]` schema
- <RepoFile path="crates/jackin-manifest/src/validate.rs" /> — limit value validation
- <RepoFile path="crates/jackin-runtime/src/runtime/launch.rs" /> — Docker arg construction
- <RepoFile path="crates/jackin/src/cli/role.rs" /> — `--memory-max` etc. flags
