...
5. A new entry in <RepoFile path="docs/content/docs/reference/schema-versions.mdx" />
...
- <RepoFile path="docs/content/docs/reference/schema-versions.mdx" /> — new timeline entry
