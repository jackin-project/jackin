...
**Status**: Open — design pattern (Phase 5, [Agent Orchestrator Research Program](/reference/roadmap/agent-orchestrator-research/))
...
- New docs page: `docs/content/docs/guides/credentials.mdx`
