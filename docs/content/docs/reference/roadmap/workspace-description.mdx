...
shape in <RepoFile path="src/cli/workspace/mod.rs" />.
...
- <RepoFile path="src/cli/workspace/mod.rs" /> — CLI flag plumbing
- <RepoFile path="src/config/workspaces/mod.rs" /> — `workspace show` renderer
- <RepoFile path="src/console/tui/state/mod.rs" /> — workspace picker
  rendering
