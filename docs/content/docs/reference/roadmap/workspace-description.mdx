...
- This is the smallest feature in the [Agent Orchestrator Research
  Program](/reference/roadmap/agent-orchestrator-research/) that demonstrably
...
- <RepoFile path="crates/jackin/src/console/tui/state.rs">crates/jackin/src/console/tui/state.rs</RepoFile> — workspace picker
  rendering
