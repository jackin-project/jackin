...
shape in <RepoFile path="crates/jackin/src/cli/workspace.rs" />.
...
- <RepoFile path="crates/jackin/src/workspace.rs" /> — `WorkspaceConfig` gains the field
- <RepoFile path="crates/jackin/src/cli/workspace.rs" /> — CLI flag plumbing
- <RepoFile path="crates/jackin-config/src/app_config_workspaces.rs" /> — `workspace show` renderer
- <RepoFile path="crates/jackin/src/console/tui/state.rs" /> — workspace picker
  rendering
