...
**Status**: Partially implemented — spec published (2026-06-02); next step is adding the `//!` link from <RepoFile path="crates/jackin-runtime/src/runtime/launch.rs">crates/jackin-runtime/src/runtime/launch.rs</RepoFile> to the spec URL, then using the spec as the oracle for the [split-runtime-launch](/reference/roadmap/split-runtime-launch/) refactor
...
**Spec published** — see [runtime/launch.rs Behavioral Spec](/internal/specs/runtime-launch/).
