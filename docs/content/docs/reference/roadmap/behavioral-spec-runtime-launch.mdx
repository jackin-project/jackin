...
**Status**: Partially implemented — spec published (2026-06-02); next step is adding the `//!` link from <RepoFile path="src/runtime/launch.rs" /> to the spec URL, then using the spec as the oracle for the [split-runtime-launch](/reference/roadmap/split-runtime-launch/) refactor
