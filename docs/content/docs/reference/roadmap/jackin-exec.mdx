...
**Status**: Partially implemented — Phase 1 code landed for capsule exec, picker, host.sock resolution, MCP registration, launch filtering, and schema support; remaining work is hardening, temp-file materialization for key credentials, and end-to-end behavioral coverage
