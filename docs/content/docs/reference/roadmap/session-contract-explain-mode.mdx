...
- <RepoFile path="src/runtime/launch/mod.rs" /> — current runtime launch path
- <RepoFile path="src/workspace/resolve/mod.rs" /> — workspace resolution
- <RepoFile path="src/workspace/planner/mod.rs" /> — resolved mount planning
- <RepoFile path="src/instance/auth/mod.rs" /> — per-instance auth behavior
- <RepoFile path="src/docker/mod.rs" /> — Docker command boundary
