...
**Status**: Open — design proposal (Phase 5, [Agent Orchestrator Research Program](/reference/roadmap/agent-orchestrator-research/))
...
- New docs page: `docs/content/docs/guides/skills.mdx`
