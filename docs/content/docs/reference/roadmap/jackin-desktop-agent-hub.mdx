...
- <RepoFile path="crates/jackin/src/console/tui/state.rs">crates/jackin/src/console/tui/state.rs</RepoFile> is the current TUI workspace
...
- Follow the repo's existing PR and commit standards for every PR in the chain:
  ...
  <RepoFile path="COMMITS.md">COMMITS.md</RepoFile>. This includes the expected PR body shape,
