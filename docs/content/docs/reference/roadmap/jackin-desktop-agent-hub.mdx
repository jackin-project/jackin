...
- <RepoFile path="crates/jackin-runtime/src/runtime/launch.rs" /> already bind-mounts the daemon
...
- <RepoFile path="crates/jackin/src/console/tui/state.rs" /> is the current TUI workspace
...
- <RepoFile path="crates/jackin-config/src/app_config_workspaces.rs" /> and <RepoFile path="crates/jackin/src/config.rs" />
  ...
  itself.
- <RepoFile path="crates/jackin-core/src/agent.rs" /> confirms the initial supported agents
