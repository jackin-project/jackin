...
- <RepoFile path="src/runtime/launch/mod.rs" /> already bind-mounts the daemon
...
- <RepoFile path="src/console/tui/state/mod.rs" /> is the current TUI workspace
...
- <RepoFile path="src/config/workspaces/mod.rs" /> and <RepoFile path="src/config/mod.rs" />
...
<RepoFile path="src/runtime/launch/mod.rs" />:
