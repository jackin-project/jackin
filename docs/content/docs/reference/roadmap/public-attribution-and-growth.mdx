...
- Can jackin' infer a repo's trailer policy from local files such as <RepoFile path="AGENTS.md">AGENTS.md</RepoFile>, <RepoFile path="COMMITS.md">COMMITS.md</RepoFile>, or <RepoFile path="CONTRIBUTING.md">CONTRIBUTING.md</RepoFile>, or should policy always be explicit config?
...
- <RepoFile path="COMMITS.md">COMMITS.md</RepoFile> — commit-message rules that any jackin' helper must respect in this repository
