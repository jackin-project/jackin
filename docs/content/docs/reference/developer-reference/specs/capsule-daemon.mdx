...
3. **INV-D15 clipboard expiry** — seam exists; drive a `ManualClock` past TTL in a unit test.

INV-D8 / INV-D19 / INV-D20 closed with Multiplexer real-path + port-wired characterization tests.
