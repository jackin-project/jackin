...
Behavioral invariant contract for the host operator console state machine — primarily <RepoFile path="crates/jackin-console/src/tui/state/manager/mod.rs">crates/jackin-console/src/tui/state/manager/mod.rs</RepoFile> and the screen `update` modules. Phase 2 console/view-model work and settings/editor unification must preserve every INV below.
