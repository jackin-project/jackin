...
| `brand/jackin-wordmark.{svg,png}` | standalone wordmark (outlined), transparent background — the file BrandMark and the TOC use |
| `brand/jackin-lockup.svg` | wordmark with the grey `by tailrocks` byline |
