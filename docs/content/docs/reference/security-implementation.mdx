...
| Container escape | Out of scope | Docker hardening tracked in [Docker runtime hardening contract](/roadmap/docker-runtime-hardening-contract/) and [smolvm backend research](/roadmap/smolvm-backend-research/) | Shared kernel; future microVM work addresses this |
