...
jackin' Capsule uses `jackin-term` as its owned terminal model. This page records why the old `vt100` dependency was retired, what `jackin-term` owns, and what changed in PR #495.
...
## What PR #495 Achieved

PR #495 made `jackin-term` the only terminal model in Capsule:
