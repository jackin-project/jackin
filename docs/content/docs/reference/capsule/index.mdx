...
[Token & Cost Telemetry](/roadmap/token-cost-telemetry/), not this
control surface.
...
- [Agent Orchestrator Research](/roadmap/agent-orchestrator-research/) — comparative analysis of Herdr and other tools that informed the design
