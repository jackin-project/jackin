...
[Token & Cost Telemetry](/reference/roadmap/token-cost-telemetry/), not this
control surface.
...
| [Agent runtime status authority roadmap item](/reference/roadmap/agent-runtime-status/) | Design record and regression checklist for the shipped in-container state authority |
