...
| `{"type":"usage_workspace","workspace":null,"window_seconds":null}` | `{"type":"usage_summary","summary":{...}}` | `jackin-capsule usage workspace [workspace] [--window-seconds N]` |
| `{"type":"usage_session","session_id":N,"window_seconds":null}` | `{"type":"usage_summary","summary":{...}}` | `jackin-capsule usage session <session_id> [--window-seconds N]` |
