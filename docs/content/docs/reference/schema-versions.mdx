...
### Config `v1alpha6` — 2026-06-04

| File kind | Predecessor | Migration mode | Fixture |
|---|---|---|---|
| Config (`config.toml`) | `v1alpha5` | Automatic on startup | <RepoFile path="tests/fixtures/migrations/config/from-v1alpha5/meta.toml" /> |

Adds optional `[runtime]` section with `default_backend = "docker"` field. Enables the operator to switch to `"apple-container"` (Apple Container backend for macOS 26 ARM). Noop migration — existing config files parse unchanged; the field defaults to `"docker"`.
...
### Workspace `v1alpha7` — 2026-06-04

| File kind | Predecessor | Migration mode | Fixture |
|---|---|---|---|
| Workspace (`workspaces/<name>.toml`) | `v1alpha6` | Automatic on startup | <RepoFile path="tests/fixtures/migrations/workspace/from-v1alpha6/meta.toml" /> |

Adds optional `[workspaces.X.runtime]` section with `backend` field for per-workspace Apple Container backend override. Noop migration — existing workspace files parse unchanged; the field is omitted when unset.
...
### Workspace `v1alpha6` — 2026-06-04

| File kind | Predecessor | Migration mode | Fixture |
|---|---|---|---|
| Workspace (`workspaces/<name>.toml`) | `v1alpha5` | Automatic on startup | <RepoFile path="tests/fixtures/migrations/workspace/from-v1alpha5/meta.toml" /> |

Adds `on_demand` flag to `OpRef` and new `Extended { value, on_demand }` variant in `EnvValue` for on-demand credential injection via `jackin-exec`. Noop migration — existing workspace files parse unchanged.

### Workspace `v1alpha5` — 2026-05-26

| File kind | Predecessor | Migration mode | Fixture |
|---|---|---|---|
| Workspace (`workspaces/<name>.toml`) | `v1alpha4` | Automatic on startup | <RepoFile path="tests/fixtures/migrations/workspace/from-v1alpha4/meta.toml" /> |
...
| File kind | Predecessor | Migration mode | Fixture |
|---|---|---|---|
| Config (`config.toml`) | `v1alpha4` | Automatic on startup | <RepoFile path="tests/fixtures/migrations/config/from-v1alpha4/meta.toml" /> |
...
| File kind | Predecessor | Migration mode | Fixture |
|---|---|---|---|
| Config (`config.toml`) | `v1alpha3` | Automatic on startup | <RepoFile path="tests/fixtures/migrations/config/from-v1alpha3/meta.toml" /> |
| Workspace (`workspaces/<name>.toml`) | `v1alpha3` | Automatic on startup | <RepoFile path="tests/fixtures/migrations/workspace/from-v1alpha3/meta.toml" /> |
| Manifest (`jackin.role.toml`) | `v1alpha3` | Desktop: `jackin role migrate <role-repo-path>`; CI/automation: `jackin-role migrate <role-repo-path>` | <RepoFile path="tests/fixtures/migrations/manifest/from-v1alpha3/meta.toml" /> |
...
| Manifest (`jackin.role.toml`) | `v1alpha2` | Desktop: `jackin role migrate <role-repo-path>`; CI/automation: `jackin-role migrate <role-repo-path>` | <RepoFile path="tests/fixtures/migrations/manifest/from-v1alpha2/meta.toml" /> |
...
| Manifest (`jackin.role.toml`) | `v1alpha1` | Desktop: `jackin role migrate <role-repo-path>`; CI/automation: `jackin-role migrate <role-repo-path>` | <RepoFile path="tests/fixtures/migrations/manifest/from-v1alpha1/meta.toml" /> |
...
| Manifest (`jackin.role.toml`) | `legacy` | Desktop: `jackin role migrate <role-repo-path>`; CI/automation: `jackin-role migrate <role-repo-path>` | <RepoFile path="tests/fixtures/migrations/manifest/from-legacy/meta.toml" /> |
