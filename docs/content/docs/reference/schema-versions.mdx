...
| File kind | Predecessor | Migration mode | Fixture |
|---|---|---|---|
| Role manifest (`jackin.role.toml`) | `v1alpha4` | Desktop: `jackin role migrate <role-repo-path>` | <RepoFile path="tests/fixtures/migrations/manifest/from-v1alpha4/meta.toml" /> |
