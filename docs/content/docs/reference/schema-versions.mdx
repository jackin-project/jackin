...
**Summary**: introduces `[docker].min_profile` (optional string), `[docker].dind` (optional string), and `network_allow` (optional array of strings). All additive with serde defaults. The migration is a no-op restamp.
