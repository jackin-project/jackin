...
| [claude-trace](https://www.npmjs.com/package/@mariozechner/claude-trace) (Mario Zechner) | records **all API traffic** incl. system prompts | fetch-patch wrapper around `claude` (vector D — the only non-file-reader here) | JSONL traffic + HTML views | npm v1.0.9 2026-04-16; low activity |
