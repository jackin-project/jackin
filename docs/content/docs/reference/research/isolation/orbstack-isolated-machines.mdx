...
**Status**: Deferred — shared-kernel architecture does not address the kernel isolation gap for the current macOS ARM audience; see [smolvm backend research](/reference/research/isolation/smolvm-backend/) for the active VM isolation track
