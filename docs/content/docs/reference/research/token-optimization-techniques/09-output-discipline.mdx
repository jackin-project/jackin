...
On the modeled heavy day (~$22, 6 sessions, ~27k output tok/session — see [01 — Token Economics and Measurement](/reference/research/token-optimization-techniques/01-economics-and-measurement/)), output is ~$8.14/day: ~$4.40 thinking + ~$3.74 visible (prose + tool arguments). Three structural facts shape everything below:
...
| Session dollar split (reads 32/writes 29/thinking 20/visible 17/uncached 2) | modeled day ~$22 | local Phase-0 heavy-session profile — see [01 — Token Economics and Measurement](/reference/research/token-optimization-techniques/01-economics-and-measurement/) |
