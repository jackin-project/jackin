...
**A. Style and language compression — beyond caveman** ([04 — Style and Language Compression — Beyond Caveman](/reference/research/token-optimization-techniques/04-style-and-language-compression/))
...
**B. Tokenizer arbitrage** ([05 — Tokenizer arbitrage](/reference/research/token-optimization-techniques/05-tokenizer-arbitrage/))
...
**C. Context architecture — what enters the window at all** ([06 — Context architecture — what enters the window at all](/reference/research/token-optimization-techniques/06-context-architecture/))
...
**D. Caching exploitation** ([07 — Caching exploitation](/reference/research/token-optimization-techniques/07-caching-exploitation/))
...
**E. Retrieval, memory, and state offloading** ([08 — Retrieval, memory, and state offloading](/reference/research/token-optimization-techniques/08-retrieval-memory-and-state/))
...
**F. Output discipline and structured generation** ([09 — Output discipline and structured generation](/reference/research/token-optimization-techniques/09-output-discipline/))
...
**G. Model routing and tiered delegation** ([10 — Model routing and tiered delegation](/reference/research/token-optimization-techniques/10-model-routing-and-delegation/))
...
**H. Multi-agent protocols and subagent compression** ([11 — Multi-agent protocols and subagent compression](/reference/research/token-optimization-techniques/11-multi-agent-protocols/))
...
**I. Provider-level features, current and beta** ([12 — Provider-level features, current and beta](/reference/research/token-optimization-techniques/12-provider-features/))
...
**J. Infrastructure-level (self-hosted / gateway tier)** ([13 — Infrastructure-level (self-hosted / gateway tier)](/reference/research/token-optimization-techniques/13-infrastructure-level/))
...
**K. Frontier — "unrealistic but maybe real"** ([14 — Frontier — unrealistic but maybe real](/reference/research/token-optimization-techniques/14-frontier-ideas/))
...
**L. Measurement tooling** (folded into [01 — Token Economics and Measurement](/reference/research/token-optimization-techniques/01-economics-and-measurement/))
...
- **Phase 0 — Baseline audit (local, no web needed).** Measure this very environment: token mass of
  ...
  recent session transcripts if available). Produce [02 — Baseline Audit of This Environment (Phase 0)](/reference/research/token-optimization-techniques/02-baseline-audit/) with real numbers.
...
- **Phase 5 — Completeness critic + roadmap.** A final pass asking "what's missing — an area not
  ...
  Then write [17 — Adoption Roadmap: Day 1 / Week 1 / Month 1](/reference/research/token-optimization-techniques/17-adoption-roadmap/).
...
- [00 — Executive Summary](/reference/research/token-optimization-techniques/00-executive-summary/) — findings in 2 pages: the stack, the math, the verdict on 10x
- [01 — Token Economics and Measurement](/reference/research/token-optimization-techniques/01-economics-and-measurement/) — token economics, measurement tooling, the modeled session profile
- [02 — Baseline Audit of This Environment (Phase 0)](/reference/research/token-optimization-techniques/02-baseline-audit/) — Phase-0 measurements of this environment + caveman verification
- [03 — Prior art and market scan](/reference/research/token-optimization-techniques/03-prior-art-and-market-scan/) — shipped products, papers, tools — the landscape with evidence tiers
- [04 — Style and Language Compression — Beyond Caveman](/reference/research/token-optimization-techniques/04-style-and-language-compression/)
- [05 — Tokenizer arbitrage](/reference/research/token-optimization-techniques/05-tokenizer-arbitrage/)
- [06 — Context architecture — what enters the window at all](/reference/research/token-optimization-techniques/06-context-architecture/)
- [07 — Caching exploitation](/reference/research/token-optimization-techniques/07-caching-exploitation/)
- [08 — Retrieval, memory, and state offloading](/reference/research/token-optimization-techniques/08-retrieval-memory-and-state/)
- [09 — Output discipline and structured generation](/reference/research/token-optimization-techniques/09-output-discipline/)
- [10 — Model routing and tiered delegation](/reference/research/token-optimization-techniques/10-model-routing-and-delegation/)
- [11 — Multi-agent protocols and subagent compression](/reference/research/token-optimization-techniques/11-multi-agent-protocols/)
- [12 — Provider-level features, current and beta](/reference/research/token-optimization-techniques/12-provider-features/)
- [13 — Infrastructure-level (self-hosted / gateway tier)](/reference/research/token-optimization-techniques/13-infrastructure-level/)
- [14 — Frontier — unrealistic but maybe real](/reference/research/token-optimization-techniques/14-frontier-ideas/) — ≥10 ideas with feasibility verdicts
- [15 — Composed Stacks: Conservative / Aggressive / Unbelievable](/reference/research/token-optimization-techniques/15-composed-stacks/) — Conservative / Aggressive / Unbelievable stacks with full math
- [16 — Validation Harness: the No-Quality-Loss Proof Protocol](/reference/research/token-optimization-techniques/16-validation-harness/) — the no-quality-loss proof protocol, runnable
- [17 — Adoption Roadmap: Day 1 / Week 1 / Month 1](/reference/research/token-optimization-techniques/17-adoption-roadmap/) — day-1 / week-1 / month-1; manual vs automatable (hooks, skills, jackin❯)
...
in [15 — Composed Stacks: Conservative / Aggressive / Unbelievable](/reference/research/token-optimization-techniques/15-composed-stacks/):
...
## 12. Validation harness ([16 — Validation Harness: the No-Quality-Loss Proof Protocol](/reference/research/token-optimization-techniques/16-validation-harness/))
...
- [ ] ≥ 10 frontier ideas in [14 — Frontier — unrealistic but maybe real](/reference/research/token-optimization-techniques/14-frontier-ideas/), each with a feasibility verdict and math.
...
- [ ] Every headline number in [00 — Executive Summary](/reference/research/token-optimization-techniques/00-executive-summary/) survived the Phase-3 adversarial pass;
...
- [ ] [16 — Validation Harness: the No-Quality-Loss Proof Protocol](/reference/research/token-optimization-techniques/16-validation-harness/) is concrete enough to run without further design work.
- [ ] [17 — Adoption Roadmap: Day 1 / Week 1 / Month 1](/reference/research/token-optimization-techniques/17-adoption-roadmap/) separates automatic (hooks/skills/plugin/jackin❯-baked) from
