...
**A. Style and language compression — beyond caveman** (`04-style-and-language-compression.md`)
...
**B. Tokenizer arbitrage** (`05-tokenizer-arbitrage.md`)
...
**C. Context architecture — what enters the window at all** (`06-context-architecture.md`)
...
**D. Caching exploitation** (`07-caching-exploitation.md`)
...
**E. Retrieval, memory, and state offloading** (`08-retrieval-memory-and-state.md`)
...
**F. Output discipline and structured generation** (`09-output-discipline.md`)
...
**G. Model routing and tiered delegation** (`10-model-routing-and-delegation.md`)
...
**H. Multi-agent protocols and subagent compression** (`11-multi-agent-protocols.md`)
...
**I. Provider-level features, current and beta** (`12-provider-features.md`)
...
**J. Infrastructure-level (self-hosted / gateway tier)** (`13-infrastructure-level.md`)
...
**K. Frontier — "unrealistic but maybe real"** (`14-frontier-ideas.md`)
...
- **Phase 5 — Completeness critic + roadmap.** A final pass asking "what's missing — an area not
  ...
  Then write `17-adoption-roadmap.md`.
...
├── 05-tokenizer-arbitrage.md
├── 06-context-architecture.md
├── 07-caching-exploitation.md
├── 08-retrieval-memory-and-state.md
├── 09-output-discipline.md
├── 10-model-routing-and-delegation.md
├── 11-multi-agent-protocols.md
├── 12-provider-features.md
├── 13-infrastructure-level.md
├── 14-frontier-ideas.md                 # ≥10 ideas with feasibility verdicts
├── 15-composed-stacks.md                # Conservative / Aggressive / Unbelievable stacks with full math
├── 16-validation-harness.md             # the no-quality-loss proof protocol, runnable
└── 17-adoption-roadmap.md               # day-1 / week-1 / month-1; manual vs automatable (hooks, skills, jackin❯)
```
...
## 12. Validation harness (`16-validation-harness.md`)
...
- [ ] ≥ 10 frontier ideas in `14-frontier-ideas.md`, each with a feasibility verdict and math.
...
- [ ] `16-validation-harness.md` is concrete enough to run without further design work.
- [ ] `17-adoption-roadmap.md` separates automatic (hooks/skills/plugin/jackin❯-baked) from
