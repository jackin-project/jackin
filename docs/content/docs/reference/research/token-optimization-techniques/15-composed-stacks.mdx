...
16-validation-harness.md screening run (n=12) once; C1's falsifier is the failed-`old_string`
...
Adds BUILDABLE frontier items (14-frontier-ideas.md) and flips the main loop. Stated honestly:
