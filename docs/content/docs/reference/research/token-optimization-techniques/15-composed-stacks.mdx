...
Working profile ([01 — Token Economics and Measurement](/reference/research/token-optimization-techniques/01-economics-and-measurement/) §5, $22 variant = 6 × measured session):
...
[16 — Validation Harness: the No-Quality-Loss Proof Protocol](/reference/research/token-optimization-techniques/16-validation-harness/) screening run (n=12) once; C1's falsifier is the failed-`old_string`
...
Adds BUILDABLE frontier items ([14 — Frontier — unrealistic but maybe real](/reference/research/token-optimization-techniques/14-frontier-ideas/)) and flips the main loop. Stated honestly:
