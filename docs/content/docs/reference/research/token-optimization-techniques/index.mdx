...
- Start: [00 — Executive Summary](/reference/research/token-optimization-techniques/00-executive-summary/) — the stack, the math, the
...
5. **Operator mid-run instructions** were folded in: (a) cavemem / cavekit / fff and the
 industry-standard/proven/engineer-verified buckets → [03 — Prior art and market scan](/reference/research/token-optimization-techniques/03-prior-art-and-market-scan/);
...
- [x] **≥10 frontier ideas**: 12 in [14 — Frontier — unrealistic but maybe real](/reference/research/token-optimization-techniques/14-frontier-ideas/), each with mechanism → math →
 feasibility verdict.
- [x] **Phase-0 baseline audit with real measured numbers**: agent rule chain token masses, the
 ...
 ([02 — Baseline Audit of This Environment (Phase 0)](/reference/research/token-optimization-techniques/02-baseline-audit/)).
...
- [x] **Three composed stacks with end-to-end dollar math** and an explicit 10x verdict + named
 binding constraint ([15 — Composed Stacks: Conservative / Aggressive / Unbelievable](/reference/research/token-optimization-techniques/15-composed-stacks/)).
- [x] **Negative-cost set explicitly identified** (15 §4: eight techniques).
- [x] **[16 — Validation Harness: the No-Quality-Loss Proof Protocol](/reference/research/token-optimization-techniques/16-validation-harness/) runnable as written**: task table with objective checkers,
 six canary classes with assertions, headless runner script, bootstrap decision rule.
- [x] **[17 — Adoption Roadmap: Day 1 / Week 1 / Month 1](/reference/research/token-optimization-techniques/17-adoption-roadmap/)** separates automatic (hooks/skills/plugin/jackin❯-baked, with
...
drew too thin. Governing gap audit and extension scope: [18 — Volume II extension: gap audit and blind-spot map](/reference/research/token-optimization-techniques/18-extension-overview/).
...
- **[19 — Code-intelligence tools: codedb, fff, CodeGraff, and alternatives](/reference/research/token-optimization-tools/19-code-intelligence-tools/)** — deep dive comparing
...
- **[20 — Qdrant and vector databases for agent context](/reference/research/token-optimization-tools/20-qdrant-and-vector-databases/)** — Qdrant/vector DB
...
- **[21 — Headroom and the context-compression layer (vs the caveman ecosystem)](/reference/research/token-optimization-tools/21-headroom-and-context-compression/)** — deep dive on
...
- **[22 — Context-compression literature and market delta (2024–2026)](/reference/research/token-optimization-tools/22-context-compression-literature-and-market/)** —
...
- **[23 — Token observability and session visualization (token-optimizer and peers)](/reference/research/token-optimization-tools/23-token-observability-and-visualization/)** — the
...
- **[24 — RTK and write-time observation compression](/reference/research/token-optimization-tools/24-rtk-and-write-time-observation-compression/)** —
...
- **[25 — sem and mq: entity-level retrieval and structural markdown queries](/reference/research/token-optimization-tools/25-sem-and-mq-structural-and-markdown-retrieval/)** —
...
alternatives:
[19 — Code-intelligence tools: codedb, fff, CodeGraff, and alternatives](/reference/research/token-optimization-tools/19-code-intelligence-tools/) compares `codedb`, `fff`, the
...
- **Qdrant follow-up:** [20 — Qdrant and vector databases for agent context](/reference/research/token-optimization-tools/20-qdrant-and-vector-databases/)
