...
[05 — Tokenizer arbitrage](/reference/research/token-optimization-techniques/05-tokenizer-arbitrage/) and [10 — Model routing and tiered delegation](/reference/research/token-optimization-techniques/10-model-routing-and-delegation/) with more samples.
...
value rise; the effort sweep lives in [09 — Output discipline and structured generation](/reference/research/token-optimization-techniques/09-output-discipline/).)
...
Re-measured over all transcripts accumulated by the end of this run in [01 — Token Economics and Measurement](/reference/research/token-optimization-techniques/01-economics-and-measurement/).
...
5-min / $1 cache-read per MTok — verified against live docs, see [01 — Token Economics and Measurement](/reference/research/token-optimization-techniques/01-economics-and-measurement/)):
...
of call count, which is why input-architecture levers ([06 — Context architecture — what enters the window at all](/reference/research/token-optimization-techniques/06-context-architecture/)) outrank style levers despite the
0.1× price.
...
- Visible-output spend: $0.61 of $3.63 (17%). Caveman-ultra cuts ~58.5% of *that*: **~$0.36, or
 ...
 also shrink subsequent cache writes/reads of those turns; quantified in [15 — Composed Stacks: Conservative / Aggressive / Unbelievable](/reference/research/token-optimization-techniques/15-composed-stacks/)).
