---
title: "16 — Model routing and tiered delegation"
---
...
| Sonnet 5 | `claude-sonnet-5` | $2 / $10 intro through 2026-08-31, then $3 / $15 | 1M | 128k | new (Opus 4.7+) | added re-verification 2026-07-05; effort defaults to `high` on API and Claude Code (T1, pricing + models overview) |
| Sonnet 4.6 (legacy) | `claude-sonnet-4-6` | $3 / $15 | 1M (~750k words) | 128k (re-verified 2026-07-05; earlier recorded as 64k) | old | 79.6% SWE-bench Verified (T3); preferred over Opus 4.5 by 59% of Claude Code users (T1, Anthropic) |
...
[Re-verified 2026-07-05: Claude Sonnet 5 uses the new (Opus 4.7+) tokenizer, so the token-ratio bonus in the downtier multipliers above applies only when the target is Sonnet 4.6 or Haiku 4.5 — Fable 5 → Sonnet 5 is the bare price ratio (5x at $2/$10 intro pricing through 2026-08-31, 3.33x at $3/$15 thereafter). Source: https://platform.claude.com/docs/en/about-claude/pricing + /docs/en/about-claude/models/overview.]
...
| Built-in Explore subagent | down (Haiku, read-only) (re-verified 2026-07-05: inherits the main session's model, capped at Opus, since 2.1.198 — downtier explicitly if wanted) | parent cache untouched | CLAUDE-CODE-TODAY, default-on |
