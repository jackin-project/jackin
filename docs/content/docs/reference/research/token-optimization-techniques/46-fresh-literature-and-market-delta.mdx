...
|---|---|---|---|
| **Fable 5 free window ends; removed from plans 06-23** | | T1 | Big — model-tiering flips to Opus 4.8 for subscribers (49). Fable 5 was suspended 2026-06-12..06-30 under an export-control directive and redeployed 2026-07-01; Pro/Max/Team/select Enterprise include it up to 50% of weekly usage limits through 2026-07-07, then usage credits at API rates — the Opus-4.8-only subscriber tiering applies only after 07-07 (https://www.anthropic.com/news/redeploying-fable-5). |
...
hit the *subscriber* directly and are folded into files 41 and the verdict (49). The verdict carries a Sonnet 5 exception — see the Sonnet 5 row above.
