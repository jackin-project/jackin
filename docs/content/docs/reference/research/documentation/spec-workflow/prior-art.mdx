...
**Status**: Reference — captures why jackin❯ did not adopt an external spec-driven tool wholesale, and what was mined from each candidate. See [Agent workflow: jackin❯-native spec-driven workflow](/roadmap/agent-workflow-cc-sdd/) under Documentation tooling for the current state and remaining decisions.
