...
- dossier cross-references: measurement method and ccusage/`/usage` — [`03-prior-art-and-market-scan.md`](/reference/research/token-optimization-techniques/03-prior-art-and-market-scan/) (record 18); the token-class decomposition and thinking-invisibility — [`02-baseline-audit.md`](/reference/research/token-optimization-techniques/02-baseline-audit/) and [`00-executive-summary.md`](/reference/research/token-optimization-techniques/00-executive-summary/); keepalive graveyard #3 — `00`/`20`; outline lever — [`51-code-intelligence-tools.md`](/reference/research/token-optimization-tools/51-code-intelligence-tools/); subscription/quota metric — [`41-subscription-and-quota-economics.md`](/reference/research/token-optimization-techniques/41-subscription-and-quota-economics/); online quality + context rot — [`47-meta-cost-governance-and-online-quality.md`](/reference/research/token-optimization-techniques/47-meta-cost-governance-and-online-quality/) and [`46-fresh-literature-and-market-delta.md`](/reference/research/token-optimization-techniques/46-fresh-literature-and-market-delta/); runnable instruments — [`tools/`](/reference/research/token-optimization-techniques/tools/)
- compression companions: [`53-headroom-and-context-compression.md`](/reference/research/token-optimization-tools/53-headroom-and-context-compression/), [`54-context-compression-literature-and-market.md`](/reference/research/token-optimization-tools/54-context-compression-literature-and-market/)
