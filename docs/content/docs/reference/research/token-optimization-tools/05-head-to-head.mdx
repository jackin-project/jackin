...
| Reaches shell / test / build / log output | ✗ | ✓ | ✓ | ✓ (77 pattern modules, 74 routed — count corrected in [15](/reference/research/token-optimization-tools/15-verification-pass-and-extended-matrix/)) |
