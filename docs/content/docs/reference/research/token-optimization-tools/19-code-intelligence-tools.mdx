...
<RepoFile path="docs/content/docs/reference/research/infrastructure/code-intelligence/architect-code-intelligence-tooling.mdx">docs/content/docs/reference/research/infrastructure/code-intelligence/architect-code-intelligence-tooling.mdx</RepoFile>.
...
## Vector databases (Qdrant) — a separate question, answered in [20 — Qdrant and vector databases](/reference/research/token-optimization-tools/20-qdrant-and-vector-databases/)
...
[20 — Qdrant and vector databases for agent context](/reference/research/token-optimization-tools/20-qdrant-and-vector-databases/).
...
- ast-grep CLI/skill decision record for jackin❯ roles: <RepoFile path="docs/content/docs/reference/research/infrastructure/code-intelligence/architect-code-intelligence-tooling.mdx">docs/content/docs/reference/research/infrastructure/code-intelligence/architect-code-intelligence-tooling.mdx</RepoFile>
