...
- jackin❯ hook/host-state hazard and the role-scoped registration pattern: [architect code-intelligence tooling roadmap](/roadmap/architect-code-intelligence-tooling/).
