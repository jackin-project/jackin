...
- **The container-adoption hazards** (host-write ban, hook reconciliation, role-scoping): [architect code-intelligence tooling roadmap](/roadmap/architect-code-intelligence-tooling/).
