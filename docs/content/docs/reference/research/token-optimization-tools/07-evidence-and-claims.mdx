...
- **Caveman** — repo `JuliusBrussee/caveman`; the family records, the tokenizer measurement battery, and the folklore ledger: dossier [03 — prior-art and market scan](/reference/research/token-optimization-techniques/03-prior-art-and-market-scan/) and [04 — style and language compression](/reference/research/token-optimization-techniques/04-style-and-language-compression/).
- **Headroom** — repo `chopratejas/headroom`; companion model `chopratejas/kompress-base`; the source audit, benchmark tables, H1–H4 records, and headroom-specific graveyard: hub [21 — headroom and context compression](/reference/research/token-optimization-tools/21-headroom-and-context-compression/).
- **RTK** — repo `rtk-ai/rtk`; the architecture doc, the per-command tables, the integration matrix, and the RTK-specific graveyard: hub [24 — RTK and write-time observation compression](/reference/research/token-optimization-tools/24-rtk-and-write-time-observation-compression/).
...
- **The compression market and cache-safety classification** (including the published RTK-vs-headroom head-to-head, the independent headroom measurements, and the "rank by evidence not stars" rule): hub [22 — context-compression literature and market](/reference/research/token-optimization-tools/22-context-compression-literature-and-market/).
- **The structural alternative** RTK and headroom are *not* (persistent symbol index): hub [19 — code-intelligence tools](/reference/research/token-optimization-tools/19-code-intelligence-tools/).
