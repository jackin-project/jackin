...
| Field | Value |
|---|---|
| Repository | `headroomlabs-ai/headroom` (moved from `chopratejas/headroom`, redirect intact; re-verified 2026-07-05) |
...
| Companion model | `chopratejas/kompress-v2-base` (ModernBERT-base, 149M) on HuggingFace — a transformer trained on agentic traces, auto-downloaded (re-verified 2026-07-05; still on the `chopratejas` HF account) |
| Latest seen | `v0.30.0` (195 PyPI releases — fast cadence; re-verified 2026-07-05) |
| Adoption (2026-06-18) | 33,359★ / 111 watchers (56,509★ / 176 watchers re-verified 2026-07-05) — PR-inflated; see [evidence](/reference/research/token-optimization-tools/07-evidence-and-claims/) |
| License | Apache-2.0 |
