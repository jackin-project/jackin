...
| [13 — Infrastructure-level (self-hosted / gateway tier)](/reference/research/token-optimization-techniques/13-infrastructure-level/) | Qdrant appears as a possible semantic-cache backend in LiteLLM; semantic response caching is a poor fit for coding agents. | Separates Qdrant-as-vector-store from semantic whole-response caching. |
| [19 — Code-intelligence tools: codedb, fff, CodeGraff, and alternatives](/reference/research/token-optimization-tools/19-code-intelligence-tools/) | Compares codedb, fff, CodeGraff, Serena, Code Context Engine, Claude Context, Sourcegraph, Qodo, and others. | Adds the raw vector database layer beneath Code Context Engine / Claude Context. |
...
- Existing semantic/RAG discussion: [08 — Retrieval, memory, and state offloading](/reference/research/token-optimization-techniques/08-retrieval-memory-and-state/)
- Existing semantic-cache discussion: [13 — Infrastructure-level (self-hosted / gateway tier)](/reference/research/token-optimization-techniques/13-infrastructure-level/)
- Existing code-intelligence comparison: [19 — Code-intelligence tools: codedb, fff, CodeGraff, and alternatives](/reference/research/token-optimization-tools/19-code-intelligence-tools/)
