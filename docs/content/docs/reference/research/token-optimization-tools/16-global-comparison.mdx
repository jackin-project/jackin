...
pxpipe joined the set on 2026-07-05 with its full teardown in [17 — pxpipe: design teardown](/reference/research/token-optimization-tools/17-pxpipe-design/); it appears in the identity strip only — the feature matrices below stay ten-tool until a source-level verification pass earns it a column.
