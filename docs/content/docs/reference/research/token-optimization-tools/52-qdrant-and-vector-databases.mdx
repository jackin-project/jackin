---
title: "52 - Qdrant and vector databases for agent context"
---
...
- Existing semantic/RAG discussion: `token-optimization-techniques/14-retrieval-memory-and-state.md`
- Existing semantic-cache discussion: `token-optimization-techniques/19-infrastructure-level.md`
- Existing code-intelligence comparison: `token-optimization-tools/51-code-intelligence-tools.md`
