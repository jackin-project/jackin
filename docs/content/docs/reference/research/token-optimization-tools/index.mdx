...
<Aside type="note">
This is the **canonical, deepest** comparison of these tools. The dossier chapters it grew out of — [53 (headroom)](/reference/research/token-optimization-tools/53-headroom-and-context-compression/), [54 (compression market)](/reference/research/token-optimization-tools/54-context-compression-literature-and-market/), and [56 (RTK)](/reference/research/token-optimization-tools/56-rtk-and-write-time-observation-compression/) — remain in place for their broader scope and cross-references, and now point here for the head-to-head.
</Aside>
...
The per-tool deep-dive chapters below originated as Volume III of the [token-optimization techniques dossier](/reference/research/token-optimization-techniques/) and moved here when the researches were fully separated (techniques / tools / engine spec); their original chapter numbers (51–57) are kept so existing cross-references stay readable.

| Deep-dive chapter | What it covers |
|---|---|
| [51 — Code-intelligence tools](/reference/research/token-optimization-tools/51-code-intelligence-tools/) | codedb, fff, CodeGraff, and the alternatives sweep (Serena, Code Context Engine, Claude Context, Sourcegraph, Qodo, Augment, ast-grep) — the retrieval-instead-of-reading tool class, with local outline/symbol-search measurements. |
| [52 — Qdrant and vector databases](/reference/research/token-optimization-tools/52-qdrant-and-vector-databases/) | Vector DBs as an optional semantic-memory/RAG backend; why none is a default code-navigation layer; the docs-corpus case. |
| [53 — Headroom deep dive](/reference/research/token-optimization-tools/53-headroom-and-context-compression/) | The full headroom record: live-zone cache safety, typed compressors, CCR, H1–H4 technique records, benchmarks, source ledger. |
| [54 — Compression literature and market](/reference/research/token-optimization-tools/54-context-compression-literature-and-market/) | The compression-market sweep + 2024–2026 literature, and the cache-safety classification of every compression move. |
| [55 — Token observability and visualization](/reference/research/token-optimization-tools/55-token-observability-and-visualization/) | token-optimizer and the JSONL/session-visualization tool class — the measurement front-end of the validation harness. |
| [56 — RTK deep dive](/reference/research/token-optimization-tools/56-rtk-and-write-time-observation-compression/) | The full RTK record: write-time observation compression, the R1 record, benchmarks, adoption guardrails, source ledger. |
| [57 — sem and mq](/reference/research/token-optimization-tools/57-sem-and-mq-structural-and-markdown-retrieval/) | Entity-level retrieval (sem, the attention ledger) and structural markdown queries (mq) — the docs/prose-bucket lever. |
