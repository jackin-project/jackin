...
| Adoption (2026-06-20) | 2,800★ / 19 watchers / 278 forks / 13 open issues — see [evidence](/reference/research/token-optimization-tools/07-evidence-and-claims/) |
