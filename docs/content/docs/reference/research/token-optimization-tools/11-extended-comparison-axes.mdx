...
For a Max-plan subscriber, dollars below the cap are sunk; the objective is **tasks-per-cap** — how far each tool stretches the 5-hour window (dossier [chapter 41](/reference/research/token-optimization/41-subscription-and-quota-economics/)). This *re-orders* the $-per-task recommendation.
