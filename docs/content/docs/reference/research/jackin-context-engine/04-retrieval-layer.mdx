...
| Semantic (fuzzy concept recall) | **none by default** | — | Deliberately absent: embeddings for code navigation never met the ≥20% bar (tools hub 20); optional docs-corpus hybrid index stays a role-level experiment |
