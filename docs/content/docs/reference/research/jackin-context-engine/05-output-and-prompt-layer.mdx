...
| `terse` (default) | plain terse-instruction: drop pleasantries/filler/hedging, complete sentences | captures most of the realizable win at lowest misread risk (dossier 15: register ladder −54% at "plain") |
