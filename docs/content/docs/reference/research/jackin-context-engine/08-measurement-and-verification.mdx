...
- **Counterfactual repricing**: what this session would have cost uncached / unrouted / unfiltered — the honest "saved" number, reconciled against `session_cost.py`-style ground truth within 5% before any A/B is trusted.
