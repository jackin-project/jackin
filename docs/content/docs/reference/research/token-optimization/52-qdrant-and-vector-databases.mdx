...
- Existing semantic/RAG discussion: `token-optimization/14-retrieval-memory-and-state.md`
- Existing semantic-cache discussion: `token-optimization/19-infrastructure-level.md`
- Existing code-intelligence comparison: `token-optimization/51-code-intelligence-tools.md`
