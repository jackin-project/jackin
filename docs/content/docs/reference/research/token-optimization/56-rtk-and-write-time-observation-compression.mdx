...
- jackin❯ hook/host-state hazard and the role-scoped MCP/hook registration pattern: <RepoFile path="docs/content/docs/roadmap/(infrastructure)/architect-code-intelligence-tooling.mdx">docs/content/docs/roadmap/(infrastructure)/architect-code-intelligence-tooling.mdx</RepoFile>; terminal-observation and token-telemetry roadmap ties: <RepoFile path="docs/content/docs/roadmap/(agent-orchestrator-research)/(phase-2-operator-surface)/terminal-observation-automation.mdx">docs/content/docs/roadmap/(agent-orchestrator-research)/(phase-2-operator-surface)/terminal-observation-automation.mdx</RepoFile>, <RepoFile path="docs/content/docs/roadmap/(agent-orchestrator-research)/(phase-3-persistence)/token-cost-telemetry.mdx">docs/content/docs/roadmap/(agent-orchestrator-research)/(phase-3-persistence)/token-cost-telemetry.mdx</RepoFile>
