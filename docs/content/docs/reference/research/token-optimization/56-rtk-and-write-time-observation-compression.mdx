...
- cross-references: caveman/cavemem records + K1/K4 — [`03-prior-art-and-market-scan.md`](/reference/research/token-optimization/03-prior-art-and-market-scan/); headroom + H1/H-K1, the caveman-vs-headroom two-way, the live-zone/write-time design point — [`53-headroom-and-context-compression.md`](/reference/research/token-optimization/53-headroom-and-context-compression/); the write-time-vs-whole-prompt cache-safety classification and the "rank by evidence not stars" rule — [`54-context-compression-literature-and-market.md`](/reference/research/token-optimization/54-context-compression-literature-and-market/); record 20 hook filtering (−94.2% local) and JSON minify (−34.3% local) — [`03-prior-art-and-market-scan.md`](/reference/research/token-optimization/03-prior-art-and-market-scan/); code-intelligence outlines (the structural alternative RTK is not) — [`51-code-intelligence-tools.md`](/reference/research/token-optimization/51-code-intelligence-tools/)
