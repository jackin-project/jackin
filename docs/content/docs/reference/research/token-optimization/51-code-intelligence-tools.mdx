...
<RepoFile path="docs/content/docs/roadmap/(infrastructure)/architect-code-intelligence-tooling.mdx">docs/content/docs/roadmap/(infrastructure)/architect-code-intelligence-tooling.mdx</RepoFile>.
...
- ast-grep CLI/skill decision record for jackin❯ roles: <RepoFile path="docs/content/docs/roadmap/(infrastructure)/architect-code-intelligence-tooling.mdx">docs/content/docs/roadmap/(infrastructure)/architect-code-intelligence-tooling.mdx</RepoFile>
