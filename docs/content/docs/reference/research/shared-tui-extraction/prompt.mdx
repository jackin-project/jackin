...
- `ratatui-core` as the base widget dependency, optional Crossterm integration, and no initial Tokio dependency;
...
- compile-checked direct, TEA, component-oriented, Flux, and buffer-only examples using the same public components without a required TermRock runtime;
