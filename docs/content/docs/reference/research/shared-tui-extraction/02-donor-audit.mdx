...
- keep Tokio subscription helpers consumer-owned so widgets never force an executor, while the executor-neutral contracts and frame driver move to the shared optional runtime module;
