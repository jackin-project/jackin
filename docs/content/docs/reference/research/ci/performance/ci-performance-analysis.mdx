...
| # | Change | Verdict |
|---|---|---|
| 9 | `cargo-hakari` (workspace-hack) | **No-adopt pending first measured delta** (plan 012): hygiene now records before/after wall-clock; flip only if a scheduled run proves a win. |
