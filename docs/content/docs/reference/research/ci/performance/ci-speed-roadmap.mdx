...
contract. The contract is a stable identifier owned by
<RepoFile path="scripts/ci/crate-test-contract.sh">scripts/ci/crate-test-contract.sh</RepoFile>,
not a hash of the complete reusable workflow. A cache-transport, artifact, or
