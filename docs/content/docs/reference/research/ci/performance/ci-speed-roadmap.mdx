...
runner platform, feature and Docker modes, and the hashed test-workflow
contract. The affected-crate selector queries those markers before matrix
...
lockfile, toolchain, test configuration, workflow contract, fuzz input, Docker
