...
- [Selectable sandbox backends](/reference/research/security/sandbox-backends/selectable-sandbox-backends/) — every backend must report whether credentials are agent-readable, command-scoped, or proxy-managed.
