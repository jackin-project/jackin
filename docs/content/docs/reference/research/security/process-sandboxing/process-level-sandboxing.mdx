...
The [selectable sandbox backends](/reference/research/security/sandbox-backends/selectable-sandbox-backends/) roadmap item covers the container-to-microVM step. This item covers the process sandbox tier — the innermost ring that wraps individual shell commands, build steps, and AI-generated code invocations.
...
|---|---|
| [Selectable sandbox backends](/reference/research/security/sandbox-backends/selectable-sandbox-backends/) | Process sandbox is the innermost tier; microVM is the outermost. Both are needed for the strongest isolation model. This item fills the per-operation gap that VM boundaries cannot close. |
...
- [Selectable sandbox backends](/reference/research/security/sandbox-backends/selectable-sandbox-backends/) — the VM/container isolation tier this item complements
