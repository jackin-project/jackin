...
**Status**: Design exploration for [Custom operator tools](/roadmap/custom-operator-tools/) (Phase 2, [Agent Orchestration Program](/reference/research/agent-orchestration/program-research/)) — not yet implemented
