...
**Status**: Design exploration for [Operator handler system](/roadmap/operator-handler-system/) (Phase 1, [Agent Orchestration Program](/reference/research/agent-orchestration/program-research/)) — not yet implemented
