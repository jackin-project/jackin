...
**Status**: Historical design rationale for the settings/editor convergence. The input ownership split, shared primitives, validation, and parity coverage shipped; the broader modal-enum and host-trait ideas below remain design options rather than committed roadmap work. Current ownership rules live in the [TUI architecture](/reference/tui/architecture/).
