...
- <RepoFile path="plans/047-daemon-lifecycle-foundation.md" /> — production daemon lifecycle and socket foundation.
- <RepoFile path="plans/048-attention-adapter-foundation.md" /> — production attention adapter on top of that daemon foundation.
