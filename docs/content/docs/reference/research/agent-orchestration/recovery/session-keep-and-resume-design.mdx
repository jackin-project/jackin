...
| F8 | Trivial | <RepoFile path="crates/jackin-runtime/src/isolation/finalize.rs">crates/jackin-runtime/src/isolation/finalize.rs</RepoFile> cites a `worktree-cleanup-assessment.mdx` doc that does not exist; fold the policy table into a real doc and fix the reference. |
...
- <RepoFile path="crates/jackin-runtime/src/isolation/finalize.rs">crates/jackin-runtime/src/isolation/finalize.rs</RepoFile> — exit assessment and the rich exit dialog.
...
- <RepoFile path="crates/jackin-runtime/src/instance/manifest.rs">crates/jackin-runtime/src/instance/manifest.rs</RepoFile> — instance manifest and restore-candidate predicates.
