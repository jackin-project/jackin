...
**Status**: Open — design proposal (Containment track, [Agent Orchestration Program](/reference/research/agent-orchestration/program-research/)). Roadmap tracking: [Session snapshot and rollback](/roadmap/session-snapshot-rollback/).
