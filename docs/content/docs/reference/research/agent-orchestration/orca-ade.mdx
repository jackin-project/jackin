...
Every borrowed idea must survive the values filter from the [Agent Orchestration Program](/roadmap/agent-orchestrator-research/#jackin-values-used-for-evaluation).
