...
**Status**: Design exploration for [Autonomous task queue](/roadmap/autonomous-task-queue/) (Phase 4, [Agent Orchestration Program](/reference/research/agent-orchestration/program-research/)). Nothing here has shipped; this page records the problem framing, prior-art comparison, and recommended shape so the roadmap item can stay short.
