...
<RepoFile path="docs/content/docs/reference/roadmap/architect-code-intelligence-tooling.mdx" />
...
[`52-qdrant-and-vector-databases.md`](/reference/research/token-optimization-research/52-qdrant-and-vector-databases/).
