---
title: "Token-Optimization Research Dossier"
---
...
Specification: [`prompt.md`](prompt.mdx).
...
- Start: [`00-executive-summary.md`](00-executive-summary.mdx) — the stack, the math, the
 verdict, the graveyard.
- Foundations: [`01`](01-economics-and-measurement.mdx) economics + instruments,
 [`02`](02-baseline-audit.mdx) measured baseline of this environment,
 [`03`](03-prior-art-and-market-scan.mdx) market scan (incl. operator-named caveman / cavemem /
 cavekit / fff).
...
- Synthesis: [`30`](30-composed-stacks.mdx) composed stacks with dollar math,
 [`31`](31-validation-harness.mdx) runnable no-quality-loss protocol,
 [`32`](32-adoption-roadmap.mdx) day-1/week-1/month-1 with automatic-vs-disciplined split.
...
drew too thin. Governing gap audit and extension scope: [`40-extension-overview.md`](40-extension-overview.mdx).

### Volume II index (40–49 band)

- [`40`](40-extension-overview.mdx) — gap audit: independent six-axis taxonomy overlaid on Volume I,
 the blind-spot map with `file:line` evidence, and the Volume II index.
- [`41`](41-subscription-and-quota-economics.mdx) — the quota-weighted cost model for a capped
 subscriber (blind spot 1).
- [`42`](42-multimodal-token-economics.mdx) — image/screenshot/PDF token costs, measured locally
 (blind spot 2).
- [`43`](43-latency-and-time-economics.mdx) — wall-clock/human-time as a second cost axis (blind spot 3).
- [`44`](44-fleet-and-multitenant-cache.mdx) — hosted cross-container/fleet cache economics (blind spot 4).
- [`45`](45-cross-agent-portability.mdx) — portability matrix across coding agents (blind spot 5).
- [`46`](46-fresh-literature-and-market-delta.mdx) — clean-room re-sweep; KV-eviction family, CAG,
 changelog drift (blind spot 6).
- [`47`](47-meta-cost-governance-and-online-quality.mdx) — cost of optimizing, budget governance,
 online quality guards (blind spot 8).
- [`48`](48-extension-frontier.mdx) — 8 new frontier ideas (not duplicating K1–K16).
- [`49`](49-extension-stacks-and-verdict.mdx) — coverage-delta ledger, verdict delta, Corrections to
...
- **[`51-code-intelligence-tools.md`](51-code-intelligence-tools.mdx)** — deep dive comparing
...
- **[`52-qdrant-and-vector-databases.md`](52-qdrant-and-vector-databases.mdx)** — Qdrant/vector DB
...
alternatives:
[`51-code-intelligence-tools.md`](51-code-intelligence-tools.mdx) compares `codedb`, `fff`, the
...
- **Qdrant follow-up:** [`52-qdrant-and-vector-databases.md`](52-qdrant-and-vector-databases.mdx)
