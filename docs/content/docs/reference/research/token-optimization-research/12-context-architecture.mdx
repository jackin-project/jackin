...
|---|---|---|---|
| <RepoFile path="AGENTS.md" /> (root, always-on) | 75 | 2,744 | under the official 200-line rule; matches Phase-0's 2,738 net of harness overhead |
| <RepoFile path=".github/AGENTS.md" /> | 317 | 10,694 | path-scoped: loads only when working there |
| <RepoFile path="docs/AGENTS.md" /> | 160 | 5,982 | path-scoped |
| <RepoFile path="crates/AGENTS.md" /> | 111 | 2,821 | path-scoped |
| <RepoFile path="crates/jackin-tui-lookbook/AGENTS.md" /> | 48 | 1,053 | path-scoped |
| <RepoFile path="docker/construct/AGENTS.md" /> | 18 | 381 | path-scoped |
...
| <RepoFile path="AGENTS.md" /> 2,744 tok/75 lines; scoped agent rule files 10,694 + 5,982 + 2,821 + 1,053 + 381 = 20,931 (88.4% scoped) | local: cat FILE \| python3 /tmp/ct.py claude-fable-5 |
