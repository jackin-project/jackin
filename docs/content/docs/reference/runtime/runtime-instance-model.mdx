...
Implementation lives in <RepoFile path="crates/jackin/src/console/adapter.rs">crates/jackin/src/console/adapter.rs</RepoFile>, <RepoFile path="crates/jackin-console/src/tui/screens/workspaces/view/list.rs">crates/jackin-console/src/tui/screens/workspaces/view/list.rs</RepoFile>, and <RepoFile path="crates/jackin-console/src/tui/input/list.rs">crates/jackin-console/src/tui/input/list.rs</RepoFile>.
...
| Foreground finalizer | <RepoFile path="crates/jackin-isolation/src/finalize.rs">crates/jackin-isolation/src/finalize.rs</RepoFile> |
