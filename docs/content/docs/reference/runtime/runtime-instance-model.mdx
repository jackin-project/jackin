...
Implementation lives in <RepoFile path="crates/jackin/src/console/tui/state.rs">crates/jackin/src/console/tui/state.rs</RepoFile>, <RepoFile path="crates/jackin/src/console/tui/view/list.rs">crates/jackin/src/console/tui/view/list.rs</RepoFile>, and <RepoFile path="crates/jackin/src/console/tui/input/list.rs">crates/jackin/src/console/tui/input/list.rs</RepoFile>.
...
| Console instance rendering/actions | <RepoFile path="crates/jackin/src/console/tui/view/list.rs">crates/jackin/src/console/tui/view/list.rs</RepoFile> and <RepoFile path="crates/jackin/src/console/tui/input/list.rs">crates/jackin/src/console/tui/input/list.rs</RepoFile> |
