...
Implementation lives in <RepoFile path="src/console/tui/state.rs" />, <RepoFile path="src/console/tui/view/list.rs" />, and <RepoFile path="src/console/tui/input/list.rs" />.
...
| Console instance rendering/actions | <RepoFile path="src/console/tui/view/list.rs" /> and <RepoFile path="src/console/tui/input/list.rs" /> |
