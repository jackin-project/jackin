...
Implementation lives in <RepoFile path="crates/jackin-runtime/src/instance/naming.rs" /> and <RepoFile path="crates/jackin-runtime/src/runtime/naming.rs" />. The full naming reference — including image names, derived resource names, lock files, roles cache layout, CLI selector formats, and worked examples — is in [Instance and Resource Naming](/reference/runtime/instance-resource-naming/).
...
Implementation lives in <RepoFile path="crates/jackin-runtime/src/instance/manifest.rs" />, <RepoFile path="crates/jackin-runtime/src/isolation/state.rs" />, and <RepoFile path="crates/jackin-runtime/src/instance.rs" />.
...
Implementation lives in <RepoFile path="crates/jackin-runtime/src/runtime/launch.rs" /> (`resolve_restore_candidate`, related restore helpers, name claiming, and launch orchestration).
...
Implementation lives in <RepoFile path="crates/jackin-runtime/src/runtime/attach.rs" /> and the hardline dispatch paths in <RepoFile path="crates/jackin/src/app.rs" />.
...
Implementation lives in <RepoFile path="crates/jackin/src/console/tui/state.rs" />, <RepoFile path="crates/jackin/src/console/tui/view/list.rs" />, and <RepoFile path="crates/jackin/src/console/tui/input/list.rs" />.
...
Implementation lives in <RepoFile path="crates/jackin-runtime/src/runtime/cleanup.rs" />.

## Source References

| Area | Source |
|---|---|
| DNS-safe names and instance IDs | <RepoFile path="crates/jackin-runtime/src/instance/naming.rs" /> |
| Docker labels and derived resource names | <RepoFile path="crates/jackin-runtime/src/runtime/naming.rs" /> |
| Instance manifest and rebuildable index | <RepoFile path="crates/jackin-runtime/src/instance/manifest.rs" /> |
| Launch, restore discovery, name claiming | <RepoFile path="crates/jackin-runtime/src/runtime/launch.rs" /> |
| Attach, inspect, session inventory | <RepoFile path="crates/jackin-runtime/src/runtime/attach.rs" /> |
| Eject, purge, orphan cleanup | <RepoFile path="crates/jackin-runtime/src/runtime/cleanup.rs" /> |
| Workspace/materialized mount state | <RepoFile path="crates/jackin-runtime/src/isolation/materialize.rs" /> and <RepoFile path="crates/jackin-runtime/src/isolation/state.rs" /> |
| Foreground finalizer | <RepoFile path="crates/jackin-runtime/src/isolation/finalize.rs" /> |
| Console instance rendering/actions | <RepoFile path="crates/jackin/src/console/tui/view/list.rs" /> and <RepoFile path="crates/jackin/src/console/tui/input/list.rs" /> |
| DinD/Testcontainers smoke coverage | <RepoFile path="crates/jackin/tests/dind_e2e.rs" /> |
