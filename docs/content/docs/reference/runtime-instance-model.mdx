...
Implementation lives in <RepoFile path="src/console/tui/state.rs" />, <RepoFile path="src/console/tui/render/list.rs" />, and <RepoFile path="src/console/tui/input/list.rs" />.
