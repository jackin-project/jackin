...
Implementation lives in <RepoFile path="src/console/manager/state.rs" />, <RepoFile path="src/console/tui/render/list.rs" />, and <RepoFile path="src/console/tui/input/list.rs" />.
...
| Console instance rendering/actions | <RepoFile path="src/console/tui/render/list.rs" /> and <RepoFile path="src/console/tui/input/list.rs" /> |
