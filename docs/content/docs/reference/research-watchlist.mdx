...
| [Zellij](https://zellij.dev/), [Ghostty](https://ghostty.org/), and [vt100](https://docs.rs/vt100/) | Multiplexer UX, terminal parser behavior, pane rendering, and screen-state representation. | Capsule multiplexer design and screen detector substrate. |
