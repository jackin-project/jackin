...
|---|---|---|
| ``jackin-tui`` and ``jackin-tui-lookbook`` | Donor coupling, public API growth, product vocabulary, render fixtures, terminal lifecycle, dependencies, and history/attribution changes before extraction. | [Shared TUI extraction research](/reference/research/shared-tui-extraction/). |
