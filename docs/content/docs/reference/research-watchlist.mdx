...
| [multicode](https://github.com/graemerocher/multicode) | Codex app-server status, OpenCode SSE/session status, descendant session roll-up, cooperative state files, GitHub/task queue surfaces, and Apple container experiments. | Agent runtime status, [Agent workflow orchestration](/roadmap/agent-workflow-orchestration/), [Autonomous task queue](/roadmap/autonomous-task-queue/), [GitHub link tracking](/roadmap/github-link-tracking/), and [Agent Orchestration Program](/roadmap/agent-orchestrator-research/). |
...
| Reference | Watch for | Where it informs jackin❯ |
|---|---|---|
| [Hazmat](https://github.com/dredozubov/hazmat) | Dedicated user isolation, seatbelt/firewall tiers, integration capability rules, Docker boundary analysis, harnesses, and threat matrix structure. | [Agent Orchestration Program](/roadmap/agent-orchestrator-research/), [Container credential exposure](/roadmap/container-credential-exposure/), and sandboxing roadmap items. |
