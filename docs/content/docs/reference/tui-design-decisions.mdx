...
Console editor field-selection row/scroll planning and mount-row direct selection focus planning now lives with editor screen update helpers in <RepoFile path="crates/jackin-console/src/tui/screens/editor/update.rs" />. Root update applies the selected row, vertical scroll offset, and workspace-mount focus flag to concrete editor state.
