...
Capsule outer-terminal title, pane-title, and OSC window-title helpers now live under <RepoFile path="crates/jackin-capsule/src/tui/title.rs" />. Daemon/session code supplies workdir, branch, PR, title, cwd, and label facts.
