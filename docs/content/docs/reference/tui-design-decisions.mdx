...
Console editor tab-move reset planning now lives with editor screen update helpers in <RepoFile path="crates/jackin-console/src/tui/screens/editor/update.rs" />. Root update applies the plan to concrete editor state and keeps only root-specific set clearing.
