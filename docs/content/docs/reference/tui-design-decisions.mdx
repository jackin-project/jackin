...
Console editor field-selection row/scroll planning, mount-row direct selection focus planning, and mouse scroll-focus routing now lives with editor screen update helpers in <RepoFile path="crates/jackin-console/src/tui/screens/editor/update.rs" />. Root update/mouse applies the selected row, vertical scroll offset, workspace-mount focus flag, and tab-content focus flag to concrete editor state.
