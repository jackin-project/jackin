...
Console settings global-mount missing-GitHub-URL wording now lives with settings screen view helpers in <RepoFile path="crates/jackin-console/src/tui/screens/settings/view.rs" />; root global-mount input supplies only the mount-info URL availability fact.
