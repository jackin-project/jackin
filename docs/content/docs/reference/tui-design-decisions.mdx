...
Console settings tab-move focus planning now lives with settings screen update helpers in <RepoFile path="crates/jackin-console/src/tui/screens/settings/update.rs" />. Root update applies the plan to concrete settings state.
