...
- **Tab bar focused**: the active tab additionally shows a `PHOSPHOR_GREEN` `━` underline bar beneath its label — the keyboard-focus cue, consistent with the "focused = bright green" rule.
