...
`ratatui` is pinned at `0.30` per-crate in each consuming crate — <RepoFile path="crates/jackin-tui/Cargo.toml">crates/jackin-tui/Cargo.toml</RepoFile>, <RepoFile path="crates/jackin-capsule/Cargo.toml">crates/jackin-capsule/Cargo.toml</RepoFile>, <RepoFile path="crates/jackin-console/Cargo.toml">crates/jackin-console/Cargo.toml</RepoFile>, <RepoFile path="crates/jackin-launch-tui/Cargo.toml">crates/jackin-launch-tui/Cargo.toml</RepoFile>, and <RepoFile path="crates/jackin-tui-lookbook/Cargo.toml">crates/jackin-tui-lookbook/Cargo.toml</RepoFile>:
