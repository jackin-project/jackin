...
- The stale-cell class is structurally impossible: one writer, one model, atomic frames, enforced by the echo-back conformance harness in `crates/jackin-capsule/src/daemon/render_conformance_tests.rs`.
