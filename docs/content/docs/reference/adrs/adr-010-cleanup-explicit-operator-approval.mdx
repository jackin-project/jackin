---
title: "ADR-010: Cleanup requires explicit operator approval"
description: "Why dirty or unpushed isolated work is preserved unless the operator explicitly deletes or discards it."
---
