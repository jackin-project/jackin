...
**Status**: Accepted
**Current state**: Toolchain pinned at `1.96.0` in <RepoFile path="rust-toolchain.toml" />. MSRV `1.94` declared in <RepoFile path="Cargo.toml" />. Edition `2024`.
**Date**: 2026-05-30
...
**MSRV: declared in <RepoFile path="Cargo.toml" /> as `rust-version`.**
...
**Edition: `2024`** (`edition = "2024"` in every crate's <RepoFile path="Cargo.toml" />). The 2024 edition floor is ≥ 1.85.
