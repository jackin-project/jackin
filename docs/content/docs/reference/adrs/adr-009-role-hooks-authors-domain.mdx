---
title: "ADR-009: Role hooks are the role author's domain"
description: "Why role hooks run exactly as authored and startup-speed policy stays in role documentation."
---
