...
- `src/console/tui/widgets/` — host-console adapters and still-local modal widgets. Shared tokens and promoted components live in <RepoFile path="crates/jackin-tui/src/components.rs" />.
