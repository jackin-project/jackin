...
- Screen modules under <RepoFile path="crates/jackin-console/src/tui/screens.rs" />, including <RepoFile path="crates/jackin-console/src/tui/screens/workspaces/model.rs" />, <RepoFile path="crates/jackin-console/src/tui/screens/workspaces/update.rs" />, <RepoFile path="crates/jackin-console/src/tui/screens/workspaces/view.rs" />, <RepoFile path="crates/jackin-console/src/tui/screens/editor/model.rs" />, <RepoFile path="crates/jackin-console/src/tui/screens/editor/update.rs" />, <RepoFile path="crates/jackin-console/src/tui/screens/settings/model.rs" />, and <RepoFile path="crates/jackin-console/src/tui/screens/settings/update.rs" /> — extracted console screen model/helper code that no longer depends on the root application crate.
