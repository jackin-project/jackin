...
- <RepoFile path="src/console/mod.rs" /> and <RepoFile path="src/console/run.rs" /> — root integration for the `run_console` entrypoint, runtime/config prompts, and instance actions.
