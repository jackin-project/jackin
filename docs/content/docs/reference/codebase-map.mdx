...
- <RepoFile path="crates/jackin-console/src/tui/components.rs" /> — promoted host-console visual components. <RepoFile path="crates/jackin-console/src/widgets/mod.rs" /> and `src/console/tui/widgets/` now contain transitional widgets and compatibility adapters that are not yet fully extracted.
