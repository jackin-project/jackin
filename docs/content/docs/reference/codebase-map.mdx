...
- Screen modules under <RepoFile path="crates/jackin-console/src/tui/screens.rs" />, including <RepoFile path="crates/jackin-console/src/tui/screens/workspaces/state.rs" />, <RepoFile path="crates/jackin-console/src/tui/screens/workspaces/update.rs" />, <RepoFile path="crates/jackin-console/src/tui/screens/editor/state.rs" />, <RepoFile path="crates/jackin-console/src/tui/screens/editor/update.rs" />, <RepoFile path="crates/jackin-console/src/tui/screens/settings/state.rs" />, and <RepoFile path="crates/jackin-console/src/tui/screens/settings/update.rs" /> — extracted console screen model/helper code that no longer depends on the root application crate.
- <RepoFile path="crates/jackin-console/src/tui/components.rs" /> — promoted host-console visual components, including the file-browser state/input/render pieces under <RepoFile path="crates/jackin-console/src/tui/components/file_browser/mod.rs" />. File-browser filesystem, sandbox, Git URL, and browser-launch adapters live outside the TUI boundary in <RepoFile path="crates/jackin-console/src/services/file_browser.rs" />. `src/console/tui/widgets/` still contains root-console transitional widgets that are not yet fully extracted.
