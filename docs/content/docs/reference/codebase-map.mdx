...
- <RepoFile path="crates/jackin-console/src/model.rs" /> plus screen modules such as <RepoFile path="crates/jackin-console/src/editor/state.rs" /> and <RepoFile path="crates/jackin-console/src/settings/state.rs" />, with siblings such as <RepoFile path="crates/jackin-console/src/list_row.rs" />, <RepoFile path="crates/jackin-console/src/workspace_summary.rs" />, and <RepoFile path="crates/jackin-console/src/mount_info.rs" /> — extracted console model/helper code that no longer depends on the root application crate.
