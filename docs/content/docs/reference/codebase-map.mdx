...
- <RepoFile path="crates/jackin-console/src/tui/message.rs" />, <RepoFile path="crates/jackin-console/src/tui/update.rs" />, <RepoFile path="crates/jackin-console/src/tui/effect.rs" />, and <RepoFile path="crates/jackin-console/src/tui/view.rs" /> — host-console top-level TUI message/update/effect carriers and frame composition helpers. Root console manager code still binds product-specific messages and executes effects while the remaining app/message/update/view files move into the surface crate.
