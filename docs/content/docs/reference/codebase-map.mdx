...
- <RepoFile path="crates/jackin-console/src/tui/run.rs" /> and <RepoFile path="crates/jackin-console/src/tui/terminal.rs" /> — extracted event-loop shell helpers and terminal lifecycle abstractions used by the root integration layer.
