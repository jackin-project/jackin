...
- <RepoFile path="crates/jackin-console/src/tui/message.rs" />, <RepoFile path="crates/jackin-console/src/tui/update.rs" />, and <RepoFile path="crates/jackin-console/src/tui/effect.rs" /> — host-console top-level TUI message/update/effect carriers. Root console manager code still binds product-specific messages and executes effects while the remaining app/message/update files move into the surface crate.
