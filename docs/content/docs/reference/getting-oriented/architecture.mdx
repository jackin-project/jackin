...
| `sidecar` | Start or recover the DinD sidecar container and its certs volume for the role container. Sidecar readiness is polled during image work, role-state preparation, and workspace materialization. |
