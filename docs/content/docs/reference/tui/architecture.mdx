...
2. **`crates/jackin-tui/`** — Product-specific compositions and Ratatui adapters shared by at least two jackin❯ surfaces. It may depend on TermRock and pure product vocabulary, but cannot own a generic theme facade, neutral widgets, terminal lifecycle, run loops, or external effects.
