...
| Status footer | [TermRock source](https://github.com/tailrocks/termrock) | White bottom status footer with left status text, usage label, container chip, and debug/run-id chip layout | Launch, console, or capsule bottom chrome that reports current run state |
