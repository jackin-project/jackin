...
| Status footer | [TermRock `StatusBar`](https://github.com/tailrocks/termrock) for launch; <RepoFile path="crates/jackin-console/src/tui/components/status_footer.rs">console copy</RepoFile> + <RepoFile path="crates/jackin-capsule/src/tui/components/status_footer.rs">Capsule copy</RepoFile> remain | Current migration residual: launch uses caller-owned TermRock slots while console and Capsule retain the same product-shaped footer implementation. The [follow-through roadmap](/roadmap/shared-tui-extraction/) converges them on the canonical widget. | Launch, console, or Capsule bottom chrome that reports current run state |
...
| Toast | [TermRock source](https://github.com/tailrocks/termrock) + <RepoFile path="crates/jackin-capsule/src/tui/components/toast.rs">Capsule migration residual</RepoFile> | TermRock owns the canonical Toast metadata/render contract; Capsule still carries placement and rendering behavior that must converge through the [follow-through roadmap](/roadmap/shared-tui-extraction/). | Copy-success or similar transient feedback that must appear outside the hint/footer row |
...
Layout and interaction primitives that support the catalogued widgets live in [TermRock source](https://github.com/tailrocks/termrock), [TermRock source](https://github.com/tailrocks/termrock), [TermRock source](https://github.com/tailrocks/termrock), [TermRock source](https://github.com/tailrocks/termrock), [TermRock source](https://github.com/tailrocks/termrock), and [TermRock source](https://github.com/tailrocks/termrock); surface-local decorative widgets such as launch rain in <RepoFile path="crates/jackin-launch-tui/src/tui/components/rain.rs">crates/jackin-launch-tui/src/tui/components/rain.rs</RepoFile> are intentionally not catalogued as shared components.
...
**Render primitives**: `modal_block` ([TermRock source](https://github.com/tailrocks/termrock)), `breadcrumb_title` (<RepoFile path="crates/jackin-console/src/tui/components/op_picker.rs">crates/jackin-console/src/tui/components/op_picker.rs</RepoFile>), `render_fatal` (<RepoFile path="crates/jackin-console/src/tui/components/op_picker.rs">crates/jackin-console/src/tui/components/op_picker.rs</RepoFile>), `render_filter_input` ([TermRock source](https://github.com/tailrocks/termrock)), `render_picker_list` ([TermRock source](https://github.com/tailrocks/termrock)), and `render_scrollable_block_at` ([TermRock source](https://github.com/tailrocks/termrock)) — use these building blocks when composing new modals rather than hand-rolling border + layout from scratch.
