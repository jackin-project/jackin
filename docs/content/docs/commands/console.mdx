...
For local visual QA, contributors can force boundary rituals with env vars rather than CLI flags; see [Launch Progress Surface](/reference/tui//#launch-progress-surface).
