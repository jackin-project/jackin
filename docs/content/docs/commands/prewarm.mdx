...
```bash
jackin prewarm [--agent <NAME>]... [--sidecar] [--sidecar-container] [--roles [--role <SELECTOR> [--role-git <URL>] | --workspace <NAME> | --all-workspaces]] [--image (--role <SELECTOR> [--role-git <URL>] | --workspace <NAME> | --all-workspaces | --all-roles) [--role-branch <BRANCH>]]
```
