...
```bash
jackin prewarm [--agent <NAME>]... [--roles [--role <SELECTOR> [--role-git <URL>] | --workspace <NAME> | --all-workspaces]] [--image (--role <SELECTOR> [--role-git <URL>] | --workspace <NAME> | --all-workspaces) [--role-branch <BRANCH>]]
```
