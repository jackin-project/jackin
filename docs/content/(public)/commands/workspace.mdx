...
jackin workspace account unassign my-app work
```
...
Create and remove registry entries with [account commands](/commands/account/). Account changes take effect on the next launch; they do not revoke tokens at the provider.
