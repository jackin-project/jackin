...
- **Auth** — named coding-agent/provider accounts, workspace account assignments, and separate GitHub CLI authentication controls. See [Authentication](/guides/authentication/) for account authorization.
