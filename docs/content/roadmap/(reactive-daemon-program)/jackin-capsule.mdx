...
- [Capsule Terminal Model](/reference/capsule/terminal-model/) — why the VT emulator was replaced twice (hand-rolled → `vt100` fork → `termpane`).
