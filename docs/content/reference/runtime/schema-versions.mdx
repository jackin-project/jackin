...
| `[accounts.<id>].provider` | string | Yes | `v1alpha10` | Credential issuer; canonical provider slugs: `anthropic`, `openai`, `amp`, `xai`, `opencode`, `moonshot`, `zai`, `minimax`, `google`, `cursor`, `meta`, or `openrouter` |
...
| `[accounts.<id>.credential.source_selector]` | table | No | `v1alpha12` | Source-bound entry/profile identity for Omp and Hermes profile credentials |
