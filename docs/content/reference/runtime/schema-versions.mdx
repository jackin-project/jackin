...
| `[accounts.<id>].provider` | string | Yes | `v1alpha10` | Credential issuer: `anthropic`, `openai`, `moonshot`, `zai`, `minimax`, or `amp` |
...
| `[accounts.<id>.credential].agent` | string | Conditional | `v1alpha10` | Target agent for `profile` and `oauth_token` credentials (`claude`, `codex`, `amp`, `kimi`, `opencode`) |
