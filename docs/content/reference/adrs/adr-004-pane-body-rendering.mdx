...
- tui-term is not a dependency. Revisit only if it supports termpane's owned model without losing typed passthrough semantics or the single-render-path invariant.
