...
jackin❯ Capsule uses [`termpane`](https://github.com/tailrocks/termpane) as its owned terminal model (a pinned git dependency, currently tag `v0.6.4`). This page records why the old `vt100` dependency was retired and what `termpane` owns.
