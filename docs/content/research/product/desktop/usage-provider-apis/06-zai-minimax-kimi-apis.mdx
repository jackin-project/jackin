...
- Two sibling endpoints exist per [opencode-glm-quota](https://github.com/guyinwonder168/opencode-glm-quota/) (MED), but they are outside jackin❯ limits-only scope and are not called (`crates/jackin-usage/CLAUDE.md` (removed in #956; consolidated into root AGENTS.md)).
