...
**Gap.** Local model engines appear once in the entire roadmap, as a passing "dev server" example. [Agent accounts](/guides/authentication/agents/) covers only cloud providers.
