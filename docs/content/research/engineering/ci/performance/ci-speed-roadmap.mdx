...
- In-job path classification in <RepoFile path=".github/workflows/docs.yml">.github/workflows/docs.yml</RepoFile>, <RepoFile path=".github/workflows/construct.yml">.github/workflows/construct.yml</RepoFile>, and <RepoFile path=".github/workflows/preview.yml">.github/workflows/preview.yml</RepoFile>, plus affected-scope selection in <RepoFile path=".github/workflows/ci-pr.yml">.github/workflows/ci-pr.yml</RepoFile>, prevent unrelated workflows from doing full work.
...
- <RepoFile path=".github/workflows/ci-pr.yml">.github/workflows/ci-pr.yml</RepoFile>
- <RepoFile path=".github/workflows/ci-main.yml">.github/workflows/ci-main.yml</RepoFile>
