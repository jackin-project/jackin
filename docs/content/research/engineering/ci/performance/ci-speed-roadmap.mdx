...
- In-job path classification and affected-scope selection in <RepoFile path=".github/workflows/ci-pr.yml">.github/workflows/ci-pr.yml</RepoFile> prevent unrelated jobs from doing full work. (The standalone `docs.yml`, `construct.yml`, and `preview.yml` workflows were consolidated into the generated PR workflow in the velnor-workflow regeneration.)
