...
- Delete `docs/` from this repo in the same release cut, and update
  ...
  <RepoFile path="AGENTS.md">AGENTS.md</RepoFile>, `docs/AGENTS.md` (removed in #956; consolidated into root AGENTS.md),
...
5. The freshness check from the docs site's own `docs/AGENTS.md` (removed in #956; consolidated into root AGENTS.md)
