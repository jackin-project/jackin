...
| <RepoFile path=".github/AGENTS.md">.github/AGENTS.md</RepoFile> (current generator-owned rules, auto-loads in `.github/`) | 10,688 | 28,645 | 2.68 |
| `docs/AGENTS.md` (removed in #956; consolidated into root AGENTS.md) (auto-loads in `docs/`) | 5,976 | 15,032 | 2.52 |
| `crates/AGENTS.md` (removed in #956; consolidated into root AGENTS.md) | 2,815 | 6,854 | 2.43 |
| `crates/jackin-tui-lookbook/AGENTS.md` | 1,047 | 2,788 | 2.66 |
| `docker/construct/AGENTS.md` (removed in #956; consolidated into root AGENTS.md) | 375 | 1,197 | 3.19 |
