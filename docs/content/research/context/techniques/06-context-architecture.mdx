...
| <RepoFile path=".github/AGENTS.md">.github/AGENTS.md</RepoFile> (current generator-owned rules) | 317 | 10,694 | path-scoped: loads only when working there |
| `docs/AGENTS.md` (removed in #956; consolidated into root AGENTS.md) | 160 | 5,982 | path-scoped |
| `crates/AGENTS.md` (removed in #956; consolidated into root AGENTS.md) | 111 | 2,821 | path-scoped |
| `crates/jackin-tui-lookbook/AGENTS.md` | 48 | 1,053 | path-scoped |
| `docker/construct/AGENTS.md` (removed in #956; consolidated into root AGENTS.md) | 18 | 381 | path-scoped |
