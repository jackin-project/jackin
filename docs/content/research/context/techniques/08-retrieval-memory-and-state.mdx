...
| `docs/AGENTS.md` (removed in #956; consolidated into root AGENTS.md) (subtree-scoped) | 5,982 | observed only after reading a file under `docs/` |
...
| <RepoFile path="AGENTS.md">AGENTS.md</RepoFile> 2,744; 12 topic files 35,769 (max <RepoFile path="PULL_REQUESTS.md">PULL_REQUESTS.md</RepoFile> 10,939); `docs/AGENTS.md` (removed in #956; consolidated into root AGENTS.md) 5,982; 93.8%/92.9% deferred | local: [checked-in token counter](/research/context/techniques/tools/#count_tokenspy-modes) per file, totals summed; measured with the checked-in counter of <RepoFile path="AGENTS.md">AGENTS.md</RepoFile> |
