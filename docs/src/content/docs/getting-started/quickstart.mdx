...
Running `jackin` with no arguments opens the console when your terminal
can host it; otherwise it silently prints help. You can also ask for it
explicitly with `jackin console`.
