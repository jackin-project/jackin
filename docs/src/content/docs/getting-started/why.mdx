...
The core isolation model works, workspaces and mounts are configurable, the interactive operator console is functional, and the agent class system supports namespaced, team-shareable environments. It's licensed under Apache 2.0.
