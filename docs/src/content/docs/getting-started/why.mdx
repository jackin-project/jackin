...
The project is at **v0.2.0** — the core isolation model works, workspaces and mounts are configurable, the interactive TUI launcher is functional, and the agent class system supports namespaced, team-shareable environments. It's licensed under Apache 2.0.
