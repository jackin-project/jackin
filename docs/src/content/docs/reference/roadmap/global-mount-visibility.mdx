...
Use [Global Mount Visibility goal prompt](/reference/goals/global-mount-visibility/) when starting the implementation goal. The goal page is an execution prompt; this roadmap remains the product and design source of truth.
