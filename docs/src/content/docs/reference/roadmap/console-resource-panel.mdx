...
`~/.jackin/data/` once on console open and incrementally on archive events;
also show free disk for the filesystem containing jackin's data directory. Do
not poll disk usage on every render.
