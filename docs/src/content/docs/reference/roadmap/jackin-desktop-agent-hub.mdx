...
sidebar destinations to the same daemon-backed menu model. Detailed filters,
launch buttons, account cards, and attention actions remain in the focused
follow-up PRs so the initial native window stays reviewable.
