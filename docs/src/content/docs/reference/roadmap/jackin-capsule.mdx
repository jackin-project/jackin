...
The binary is named `jackin-capsule` and lives at `/usr/local/bin/jackin-capsule` inside every Capsule-managed role container. It replaces <RepoFile path="docker/runtime/supervisor.sh" /> as PID 1.
