...
| [Agent workflow orchestration](/reference/roadmap/agent-workflow-orchestration/) | Deterministic multi-agent workflow graphs, visible terminal sessions, GitHub-facing progress, adversarial external-orchestrator research, and a low-regret first implementation target around run records plus GitHub reporting | Task source; persistent storage; agent runtime status; Capsule session control |
