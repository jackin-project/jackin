...
| [Agent workflow orchestration](/reference/roadmap/agent-workflow-orchestration/) | Deterministic multi-agent workflow graphs, visible terminal sessions, and GitHub-facing progress | Task source; persistent storage; agent runtime status; Capsule session control |
