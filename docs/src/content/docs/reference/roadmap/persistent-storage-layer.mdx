...
-- Provider account quota cache. This is daemon-global in the future
-- Desktop/usage program; keep the shape here so token telemetry does
-- not invent a parallel state file.
