...
- [Workspaces](/guides/workspaces/), [Mounts](/guides/mounts/), [Configuration](/reference/configuration/), [Architecture](/reference/architecture/) — doc pages to update alongside the code change
