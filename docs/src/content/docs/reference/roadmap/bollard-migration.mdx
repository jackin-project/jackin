...
- [`src/docker.rs`](https://github.com/jackin-project/jackin/blob/main/src/docker.rs) — `ShellRunner`, command execution
- [`src/runtime/cleanup.rs`](https://github.com/jackin-project/jackin/blob/main/src/runtime/cleanup.rs) — `is_missing_cleanup_error()`, orphan GC Docker calls
- [`src/runtime/launch.rs`](https://github.com/jackin-project/jackin/blob/main/src/runtime/launch.rs) — `launch_agent_runtime()` Docker run invocation
- [`src/runtime/attach.rs`](https://github.com/jackin-project/jackin/blob/main/src/runtime/attach.rs) — `attach_running()`, `inspect_container_state()`
- [`src/runtime/image.rs`](https://github.com/jackin-project/jackin/blob/main/src/runtime/image.rs) — `build_agent_image()` Docker build invocation
