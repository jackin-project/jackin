---
title: "DinD Running Without TLS Authentication"
---
...
- [`src/runtime/launch.rs`](https://github.com/jackin-project/jackin/blob/main/src/runtime/launch.rs) — `launch_agent_runtime` DinD startup
- [`docs/src/content/docs/guides/security-model.mdx`](https://github.com/jackin-project/jackin/blob/main/docs/src/content/docs/guides/security-model.mdx)
- [`docs/src/content/docs/reference/architecture.mdx`](https://github.com/jackin-project/jackin/blob/main/docs/src/content/docs/reference/architecture.mdx)
