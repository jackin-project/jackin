...
| [Unified TUI scrollbars](/reference/roadmap/unified-tui-scrollbars/) | Scrollbar math, clamping, rendering, and mouse hit testing are split between `jackin-tui`, `console/widgets/scrollable.rs`, launch progress, manager input, and capsule rendering | `crates/jackin-tui`, `src/console/widgets`, <RepoFile path="src/runtime/progress.rs" />, `crates/jackin-capsule` | One shared scroll model; fixes sticky overscroll in the Docker build log panel |
