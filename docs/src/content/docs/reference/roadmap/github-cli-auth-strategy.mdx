...
- **Bidirectional shared-store sync** — moved to the dedicated
  [Live bidirectional auth sync](/reference/roadmap/live-auth-sync/)
  roadmap item. `sync` today flows host → container only; the
  reverse direction lands as a per-axis adapter against the
  [jackin daemon](/reference/roadmap/jackin-daemon/), not as a
  follow-up under this strategy doc.
...
- [Open review findings](/reference/roadmap/open-review-findings/)
