...
- [`docker/construct/Dockerfile`](https://github.com/jackin-project/jackin/blob/main/docker/construct/Dockerfile)
- [`src/derived_image.rs`](https://github.com/jackin-project/jackin/blob/main/src/derived_image.rs)
- [`docs/src/content/docs/developing/construct-image.mdx`](https://github.com/jackin-project/jackin/blob/main/docs/src/content/docs/developing/construct-image.mdx)
