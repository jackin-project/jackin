...
- Source — [`lib/src/services/root_session_service.rs`](https://github.com/graemerocher/multicode/blob/main/lib/src/services/root_session_service.rs) (SSE event stream → status state)
- Source — [`lib/src/services/opencode_client_service.rs`](https://github.com/graemerocher/multicode/blob/main/lib/src/services/opencode_client_service.rs) (the SSE client itself)
