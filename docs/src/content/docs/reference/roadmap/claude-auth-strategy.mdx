...
- <RepoFile path="docs/src/content/docs/guides/authentication/agents.mdx" /> — explain concurrent-session tradeoffs and token mode
...
- <RepoFile path="docs/src/content/docs/guides/authentication/agents.mdx" /> — current forwarding model and troubleshooting
