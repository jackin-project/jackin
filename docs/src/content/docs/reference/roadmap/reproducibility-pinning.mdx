...
- [`src/config/agents.rs`](https://github.com/jackin-project/jackin/blob/main/src/config/agents.rs) — `resolve_agent_source()`; `AgentSource` (defined in [`src/config/mod.rs`](https://github.com/jackin-project/jackin/blob/main/src/config/mod.rs)) would need version/commit fields
- [`src/runtime/repo_cache.rs`](https://github.com/jackin-project/jackin/blob/main/src/runtime/repo_cache.rs) — `resolve_agent_repo`, repo checkout logic; calls into config layer to resolve source
- [`src/manifest/mod.rs`](https://github.com/jackin-project/jackin/blob/main/src/manifest/mod.rs) — version/provenance metadata
