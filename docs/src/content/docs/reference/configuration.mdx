...
| `allowed_roles` | List of allowed agent selectors |
| `default_role` | Default agent selector |
| `harness` | Optional workspace default harness (`"claude"` or `"codex"`). Omit to default to Claude. |
