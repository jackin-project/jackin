...
jackin is at **v0.2.0** — a functional proof of concept with Claude Code as its first supported agent runtime, namespaced agent classes, workspace management, and an interactive TUI launcher.
