...
- [Role authoring CLI](/reference/roadmap/role-authoring-cli/) — shipped `jackin role validate`, `jackin role migrate`, and `jackin role create`; roadmap tracks bulk cached-role migration and richer scaffolding policy
