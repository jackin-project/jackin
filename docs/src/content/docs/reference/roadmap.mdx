...
- [Launch progress TUI](/reference/roadmap/launch-progress-tui/) — run IDs, JSONL diagnostics, boundary rain gating, structured launch stages, compact/rich/test renderers, console-triggered launch reuse, `--no-rain`, `--no-tui`, and reduced-motion support shipped; roadmap tracks diagnostics viewer, broader rich-render snapshots, and deeper startup parallelization
