...
- [Unique container identity and restore](/reference/roadmap/unique-container-identity-restore/) — new launches use DNS-safe unique container identities, per-instance manifests, a rebuildable instance index, and legacy isolation-state manifest backfill; roadmap tracks the hardline recovery picker, console recovery UI, and stronger recovery guarantees
