---
title: "Launch Progress TUI current PR goal prompt"
---

This page is an execution prompt, not the product proposal. Copy the prompt
below when continuing the current Launch Progress TUI implementation pull
request.

Source of truth:

- [Launch Progress TUI roadmap](/reference/roadmap/launch-progress-tui/)
- [Snapshot tests for TUI render](/reference/roadmap/snapshot-tests-tui/)
- [Roadmap overview](/reference/roadmap/)
- Current implementation PR/branch: `docs/launch-progress-run-diagnostics`
