...
The pre-launch hook runs inside the container after plugin installation but before the agent (Claude Code or Codex) launches. It has access to all resolved environment variables.
