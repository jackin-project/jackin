...
- Pane border title (`user@host:cwd`) emitted via OSC 0/2 on every prompt — the jackin-container multiplexer reads it and renders it as the pane title (the same mechanism zellij uses)
