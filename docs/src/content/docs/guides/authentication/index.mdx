...
Configure `ZAI_API_KEY` to unlock Z.AI as a selectable provider for Claude Code sessions — a cost-efficient Anthropic-compatible endpoint that runs alongside Anthropic tabs in the same container.
