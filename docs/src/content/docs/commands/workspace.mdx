...
| `--harness <claude\|codex>` | Default harness for this workspace |
...
jackin workspace create codex-app --workdir ~/Projects/codex-app --harness codex
...
| `--default-role <NAME>` | Set default agent |
| `--clear-default-role` | Clear the default agent |
| `--harness <claude\|codex>` | Set default harness |
| `--clear-harness` | Clear the explicit harness and fall back to Claude |
