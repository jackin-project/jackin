...
| `--agent <claude\|codex>` | Default agent for this workspace |
...
jackin workspace create codex-app --workdir ~/Projects/codex-app --agent codex
...
| `--agent <claude\|codex>` | Set default agent |
| `--clear-agent` | Clear the explicit agent and fall back to Claude |
