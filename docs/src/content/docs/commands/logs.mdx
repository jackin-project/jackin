...
Reader-task EOF and child-reaper events are both logged; the difference between them is load-bearing when triaging "agent exited but pane stayed open" reports — see [`reference/jackin-capsule`](/reference/jackin-capsule/) for the lifecycle model.
