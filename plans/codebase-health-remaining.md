...
- [ ] `crates/jackin-capsule/src/tui/components/dialog.rs` — 1920L (File4: github_context full, usage type, constructors, container_info extracted as impl blocks + reexports; coordinator 1920L; lib/clippy green after fmt).
