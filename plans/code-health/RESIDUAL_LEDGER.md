...
| R-038-env-console-tail | plan 038 long tail | **DEFER** (partial) | +058–063: doctor, roles, env resolve, console services, ConfigEditor, AppConfig CRUD, isolation list/drift. Remaining: TUI display labels, runtime restore/auth_error display strings, materialize_workspace log/param strings, token_setup path helpers. | Next: materialize_workspace public param or TUI |
