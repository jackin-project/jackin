...
| R-038-env-console-tail | plan 038 long tail | **DEFER** (partial) | +058–062: doctor, roles, env resolve, console services, ConfigEditor writers, AppConfig require/edit/remove. Remaining: TUI label plumbing, runtime restore/auth_error strings, isolation materialize, token_setup helper internals (path stamps). | Next: isolation/runtime restore or TUI |
