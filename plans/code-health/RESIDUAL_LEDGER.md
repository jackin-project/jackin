...
| R-thiserror-mid-tranches | matrix Phase 2 | **DEFER** (partial) | 037 core+env; **065** instance; **066** isolation; **067** docker (`DockerError`). Remaining measured: config ~66, image ~23. | Next crate plan: image ∥ config |
