...
| R-038-env-console-tail | plan 038 long tail | **DEFER** (partial) | +058 doctor; +059 roles; +060 env resolve; +061 console services + ConfigEditor writers. Remaining: TUI display strings, runtime restore/auth_error labels, isolation materialize, token_setup internal helpers, AppConfig.edit_workspace map keys. | Next: AppConfig.edit_workspace + isolation |
