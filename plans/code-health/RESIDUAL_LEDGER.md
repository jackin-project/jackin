...
| R-038-env-console-tail | plan 038 long tail | **DEFER** (partial) | +058 doctor; +059 roles resolve; +060 **env operator-resolve**. Remaining: console launch/save, runtime restore, editor TOML writers (`workspace: &str`). | Next: console launch/save or editor writers |
