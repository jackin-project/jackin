...
- [ ] Dependency-viz decision recorded on the map page
- [ ] Freshness gate runs post-checkout in its own visible job; synthetic-diff proof exists; severity decision recorded
