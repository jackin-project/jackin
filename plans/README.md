...
| [native-macos-usage-menu-bar/](native-macos-usage-menu-bar/) | Host-global usage cache, Tahoe UI, arm64 static PR gate, release/cask pipeline | 001–002, 005–006 **DONE**; 003–004 **BLOCKED** on Apple `release-macos` secrets + first notarized publish/cask merge |
