...
6. Governance docs: `AGENTS.md` (+ `CLAUDE.md` symlink), `CONTRIBUTING.md` (DCO, Conventional Commits, the bootstrap direct-`main` exception with its end date at first tag), `SECURITY.md`, `TESTING.md`, `ENGINEERING.md`, `PULL_REQUESTS.md`.
