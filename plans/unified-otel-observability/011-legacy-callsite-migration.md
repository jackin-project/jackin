...
- The reconciled evidence is [`worksheets/011-site-census.md`](worksheets/011-site-census.md): 501 generic macro anchors, 25 scoped diagnostic stderr anchors, and the final raw-tracing implementation inventory. The generated [`worksheets/011-error-ownership-census.md`](worksheets/011-error-ownership-census.md) pins current generic ownership carriers and recorders.
